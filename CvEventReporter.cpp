...
void CvEventReporter::improvementBuilt(int iImprovementType, int iX, int iY, bool bWorker)
{
	m_kPythonEventMgr.reportImprovementBuilt(iImprovementType, iX, iY, bWorker);
}
