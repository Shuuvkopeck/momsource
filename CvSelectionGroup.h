...
public:
	...
	bool groupAttack(int iX, int iY, int iFlags, bool& bFailedAlreadyFighting, bool bPortal = false);
...
/*************************************************************************************************/
    ...
    virtual bool isHeadUnit(CvUnit* pUnit) = 0;
	virtual int AI_GroupPower(CvPlot* pPlot, bool bDefensiveBonuses) const = 0;
	virtual void AI_GroupRangeStrike() = 0;
	int getNumUnitsValidForEquipment(PromotionTypes eEquipment, bool bYieldCost = false);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/************************************************************************************************/
