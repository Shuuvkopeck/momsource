...
/**						                                            							**/
/*************************************************************************************************/
CvAIPromotionSpecializationInfo* CyGlobalContext::getAIPromotionSpecializationInfo(int i) const
{
	return (i>=0 && i<GC.getNumAIPromotionSpecializationInfos()) ? &GC.getAIPromotionSpecializationInfo((AIPromotionSpecializationTypes) i) : NULL;
}
/**	ADDON (Adventure) Sephi                                                      					**/
CvAdventureInfo* CyGlobalContext::getAdventureInfo(int i) const
{
	return (i>=0 && i<GC.getNumAdventureInfos()) ? &GC.getAdventureInfo((AdventureTypes) i) : NULL;
}

CvAdventureStepInfo* CyGlobalContext::getAdventureStepInfo(int i) const
{
	return (i>=0 && i<GC.getNumAdventureStepInfos()) ? &GC.getAdventureStepInfo((AdventureStepTypes) i) : NULL;
}
/** ADDON (Mana Schools) Sephi **/
CvManaschoolInfo* CyGlobalContext::getManaschoolInfo(int i) const
{
	return (i>=0 && i<GC.getNumManaschoolInfos()) ? &GC.getManaschoolInfo((ManaschoolTypes) i) : NULL;
}
/**	ADDON (Combatauras) Sephi																	**/
CvCombatAuraInfo* CyGlobalContext::getCombatAuraInfo(int i) const
{
	return (i>=0 && i<GC.getNumCombatAuraInfos()) ? &GC.getCombatAuraInfo((CombatAuraTypes) i) : NULL;
}

CvCombatAuraClassInfo* CyGlobalContext::getCombatAuraClassInfo(int i) const
{
	return (i>=0 && i<GC.getNumCombatAuraClassInfos()) ? &GC.getCombatAuraClassInfo((CombatAuraClassTypes) i) : NULL;
}

CvEquipmentCategoryInfo* CyGlobalContext::getEquipmentCategoryInfo(int i) const
{
	return (i>=0 && i<GC.getNumEquipmentCategoryInfos()) ? &GC.getEquipmentCategoryInfo((EquipmentCategoryTypes) i) : NULL;
}

CvDurabilityInfo* CyGlobalContext::getDurabilityInfo(int i) const
{
	return (i>=0 && i<GC.getNumDurabilityInfos()) ? &GC.getDurabilityInfo((DurabilityTypes) i) : NULL;
}

CvDungeonInfo* CyGlobalContext::getDungeonInfo(int i) const
{
	return (i>=0 && i<GC.getNumDungeonInfos()) ? &GC.getDungeonInfo((DungeonTypes) i) : NULL;
}

CvDungeonEventInfo* CyGlobalContext::getDungeonEventInfo(int i) const
{
	return (i>=0 && i<GC.getNumDungeonEventInfos()) ? &GC.getDungeonEventInfo((DungeonEventTypes) i) : NULL;
}

CvLairResultInfo* CyGlobalContext::getLairResultInfo(int i) const
{
	return (i>=0 && i<GC.getNumLairResultInfos()) ? &GC.getLairResultInfo((LairResultTypes) i) : NULL;
}

CvCityStateInfo* CyGlobalContext::getCityStateInfo(int i) const
{
	return (i>=0 && i<GC.getNumCityStateInfos()) ? &GC.getCityStateInfo((CityStateTypes) i) : NULL;
}
...
CvFeatureClassInfo* CyGlobalContext::getFeatureClassInfo(int i) const
{
	return (i>=0 && i<GC.getNumFeatureClassInfos()) ? &GC.getFeatureClassInfo((FeatureClassTypes) i) : NULL;
}

CvPlaneInfo* CyGlobalContext::getPlaneInfo(int i) const
{
	return (i>=0 && i<GC.getNumPlaneInfos()) ? &GC.getPlaneInfo((PlaneTypes) i) : NULL;
}

CvCitySpecializationInfo* CyGlobalContext::getCitySpecializationInfo(int i) const
{
	return (i>=0 && i<GC.getNumCitySpecializationInfos()) ? &GC.getCitySpecializationInfo((CitySpecializationTypes) i) : NULL;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
CvInfoBase* CyGlobalContext::getAIGroupInfo(int i) const
{
	return (i>=0 && i<NUM_AIGROUP_TYPES) ? &GC.getAIGroupInfo((AIGroupTypes)i) : NULL;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
CvInfoBase* CyGlobalContext::getWildmanaConceptInfo(int i) const
{
	return (i>=0 && i<GC.getNumWildmanaConceptInfos()) ? &GC.getWildmanaConceptInfo((WildmanaConceptTypes)i) : NULL;
}

CvInfoBase* CyGlobalContext::getWildmanaGuideInfo(int i) const
{
	return (i>=0 && i<GC.getNumWildmanaGuideInfos()) ? &GC.getWildmanaGuideInfo((WildmanaGuideTypes)i) : NULL;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**	ADDON (WINAMP) merged Sephi																	**/
/*************************************************************************************************/
CyWinamp* CyGlobalContext::getCyWinamp() const
{
	static CyWinamp cyWinamp(&GC.getWinamp());
	return &cyWinamp;
}
/*************************************************************************************************/
/**	ADDON (WINAMP)						END														**/
