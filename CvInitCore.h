...
//FfH: Added by Kael 10/07/2007
	DllExport void reassignPlayerAdvanced(PlayerTypes eOldID, PlayerTypes eNewID, int iTimer);
//FfH: End Add
...
/**			Some nifty tricks to handle savegame issues, haven't looked closely at it yet		**/
