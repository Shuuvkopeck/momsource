...
/*************************************************************************************************/
		.def("getNumWildmanaConceptInfos", &CyGlobalContext::getNumWildmanaConceptInfos, "int () - NumWildmanaConceptInfos")
		.def("getWildmanaConceptInfo", &CyGlobalContext::getWildmanaConceptInfo, python::return_value_policy<python::reference_existing_object>(), "WildmanaConcept Info () - Returns info object")

		.def("getNumWildmanaGuideInfos", &CyGlobalContext::getNumWildmanaGuideInfos, "int () - NumWildmanaGuideInfos")
		.def("getWildmanaGuideInfo", &CyGlobalContext::getWildmanaGuideInfo, python::return_value_policy<python::reference_existing_object>(), "Wildmana Guide Info () - Returns info object")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
