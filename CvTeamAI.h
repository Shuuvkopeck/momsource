...
public:
	...
	TeamTypes AI_getWarPlanTarget() const;
	void AI_setWarPlanTarget(TeamTypes eNewTeam);
	...
	int AI_getWarValue(TeamTypes eIndex) const;
	void AI_setWarValue(TeamTypes eIndex, int iNewValue);
	int AI_getWarValueAccumulated(TeamTypes eIndex) const;
	void AI_setWarValueAccumulated(TeamTypes eIndex, int iChange);
	void AI_changeWarValueAccumulated(TeamTypes eIndex, int iChange);
	void calculateWarValues();
...
/************************************************************************************************/
	...
	int AI_getOurPlotStrength(CvPlot* pPlot, int iRange, bool bDefensiveBonuses, bool bTestMoves, bool bIncludeVassals);
/************************************************************************************************/
