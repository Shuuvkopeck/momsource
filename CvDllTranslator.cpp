...
/*************************************************************************************************/
	aIconMap[L"[ICON_MANA]"] = std::wstring(1, (wchar)GC.getCommerceInfo(COMMERCE_MANA).getChar());
	aIconMap[L"[ICON_FAITH]"] = std::wstring(1, (wchar)GC.getCommerceInfo(COMMERCE_FAITH).getChar());
	aIconMap[L"[ICON_ARCANE]"] = std::wstring(1, (wchar)GC.getCommerceInfo(COMMERCE_ARCANE).getChar());
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	...
	aIconMap[L"[ICON_LUMBER]"] = std::wstring(1, (wchar)GC.getYieldInfo(YIELD_LUMBER).getChar());
	aIconMap[L"[ICON_LEATHER]"] = std::wstring(1, (wchar)GC.getYieldInfo(YIELD_LEATHER).getChar());
	aIconMap[L"[ICON_METAL]"] = std::wstring(1, (wchar)GC.getYieldInfo(YIELD_METAL).getChar());
	aIconMap[L"[ICON_HERB]"] = std::wstring(1, (wchar)GC.getYieldInfo(YIELD_HERB).getChar());
	aIconMap[L"[ICON_STONE]"] = std::wstring(1, (wchar)GC.getYieldInfo(YIELD_STONE).getChar());
	//create color map
