...
public:
	...
	void doResearchScreen(CvWidgetDataStruct &widgetDataStruct);
...
//FfH: Added by Kael 07/23/2007
	void doPediaSpellJump(CvWidgetDataStruct &widgetDataStruct);
//FfH: End Add
...
/**	ADDON(Screen) Sephi					                                                        **/
/*************************************************************************************************/
	void doMagicScreen(CvWidgetDataStruct &widgetDataStruct);
	void doSpellResearchScreen(CvWidgetDataStruct &widgetDataStruct);
	void doSpellGuildScreen(CvWidgetDataStruct &widgetDataStruct);
	void doTraitFromCulture(CvWidgetDataStruct &widgetDataStruct);
	void doSummon(CvWidgetDataStruct &widgetDataStruct);
	void doTerraform(CvWidgetDataStruct &widgetDataStruct);
	void doGlobalenchantment(CvWidgetDataStruct &widgetDataStruct);
	void RemoveGlobalenchantment(CvWidgetDataStruct &widgetDataStruct);
	void doCityInfrastructureIncrease(CvWidgetDataStruct &widgetDataStruct);
	void doCultureAchievement(CvWidgetDataStruct &widgetDataStruct);	
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
...
//	void parsePopupQueue(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	...
	void parseGoldHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseGlobalCultureHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);	
	void parseCitySpecializationHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseCivCounterElohimHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseCivCounterScionsHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseManaHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseUnitLimitHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);	
	void parseFaithHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);	
	void parseGlobalYieldHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer, YieldTypes eYield);
	...
	void parseEquipmentHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
//FfH: Added by Kael 07/23/2007
	void parseSpellHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
//FfH: End Add
...
//>>>>BUGFfH: Added by Denev 2009/09/10
	...
	void parseSpecialistHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
