...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("hurryStone", &CyCity::hurryStone, "int (HurryID) - total value of gold when hurrying")
		...
		.def("getGreatPeopleUnitRateTotal", &CyCity::getGreatPeopleUnitRateTotal, "int (int /*UnitTypes*/ iIndex)")		
