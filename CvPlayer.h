...
//	bool canBuild(const CvPlot* pPlot, BuildTypes eBuild, bool bTestEra = false, bool bTestVisible = false) const;	// Exposed to Python
	...
	void setExtraBuildingHappiness(BuildingTypes eIndex, int iValue);
	...
	void setExtraBuildingHealth(BuildingTypes eIndex, int iValue);
...
/** new Mana    **/
	...
	void changeImprovementDiscountPercent(int iChange);
