...
void CyTeamPythonInterface()
{
	...
	python::class_<CyTeam>("CyTeam")
		...
		.def("hasMasteredTech", &CyTeam::hasMasteredTech, "bool (int)")		
/*************************************************************************************************/
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/**																								**/
/**						                                            							**/
/*************************************************************************************************/
		.def("isHasCorporationSupport", &CyTeam::isHasCorporationSupport, "bool (int)")
		.def("setHouseErebus", &CyTeam::setHouseErebus, "void (bool)")
		.def("isHouseErebus", &CyTeam::isHouseErebus,"bool ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	;
