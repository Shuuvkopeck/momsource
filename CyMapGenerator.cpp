...
void CyMapGenerator::addKelp()
{
	if (m_pMapGenerator)
		m_pMapGenerator->addKelp();
}
...
void CyMapGenerator::addImprovements()
{
	if (m_pMapGenerator)
		m_pMapGenerator->addImprovements();
}

void CyMapGenerator::addUniqueImprovements()
{
	if (m_pMapGenerator)
		m_pMapGenerator->addUniqueImprovements();
}
//FfH: End Add
