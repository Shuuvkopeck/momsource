...
public:
	...
	int hurryStone(int /*HurryTypes*/ iHurry);
	...
	int getGreatPeopleThreshold();
	int getGreatPeopleUnitRate(int /*UnitTypes*/ iIndex);
	int getGreatPeopleUnitRateTotal(int /*UnitTypes*/ iIndex);
...
/*************************************************************************************************/
    void swapAustrinCities(CyPlot* pNewPlot);
...
/*************************************************************************************************/
	...
	int calculateImprovementInfrastructureCost();
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
	int getBuildingBonusChange(int /*BuildingClassTypes*/ eBuildingClass, int /*BonusTypes*/ eBonus) const;
	void setBuildingBonusChange(int /*BuildingClassTypes*/ eBuildingClass, int /*BonusTypes*/ eBonus, int iChange);
/*************************************************************************************************/
