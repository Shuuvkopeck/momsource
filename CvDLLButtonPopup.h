...
private:
	...
	bool launchChooseSpellResearchPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchChooseGuildPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchChooseReligionPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchDungeonEventPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchChooseSacredKnowledgePopup(CvPopup* pPopup, CvPopupInfo &info);
...
/**	ADDON(Screen) Sephi					                                                        **/
/*************************************************************************************************/
	bool launchNewTraitPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchSummonPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchTerraformPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchGlobalenchantmentPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchRemoveGlobalenchantmentPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchPickEquipmentPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchCityInfrastructureIncreasePopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchCulturalAchievementPopup(CvPopup* pPopup, CvPopupInfo &info);
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
