...
public:
	...
	//Darksavant
	//Added for divine judgement
	int getDivineJudgementCounter() const;
	void setDivineJudgementCounter(int iCount);
...
/*************************************************************************************************/
	...
	void setHouseErebus( bool bNewValue);
	bool isHouseErebus() const; 
	void changeSeeEverything(int iChange);
	bool isSeeEverything() const;
	void changeCulturalAchievementsCount(int iChange);
	int getCulturalAchievementsCount() const;
	bool isCityState() const;
	int getWarPower(TeamTypes eTeam) const;
	int getNumAvailableBonuses(BonusTypes eBonus) const;
	bool hasMasteredTech(TechTypes eTech) const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	bool m_bHouseErebus;
	int m_iSeeEverything;
	int m_iCulturalAchievementsCount;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
