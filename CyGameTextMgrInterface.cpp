...
/*************************************************************************************************/
		.def("getManaStr", &CyGameTextMgr::getManaStr, "wstring (int /*PlayerTypes*/ iPlayer)")
		.def("getUnitSupportStr", &CyGameTextMgr::getUnitSupportStr, "wstring (int /*PlayerTypes*/ iPlayer)")
		.def("getFaithStr", &CyGameTextMgr::getFaithStr, "wstring (int /*PlayerTypes*/ iPlayer)")
		.def("getGlobalCultureStr", &CyGameTextMgr::getGlobalCultureStr, "wstring (int /*PlayerTypes*/ iPlayer)")
		.def("getArcaneStr", &CyGameTextMgr::getArcaneStr, "wstring (int /*PlayerTypes*/ iPlayer)")
		.def("getGlobalYieldStr", &CyGameTextMgr::getGlobalYieldStr, "wstring (int /*PlayerTypes*/ iPlayer, int iYieldType)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//		.def("parseTraits", &CyGameTextMgr::parseTraits, "wstring (int /*TraitTypes*/ iTrait, int /*CivilizationTypes*/ iCivilization, bool bDawnOfMan)")
		.def("parseTraits", &CyGameTextMgr::parseTraits, "wstring (int /*TraitTypes*/ iTrait, int /*CivilizationTypes*/ iCivilization, bool bTemporary, bool bCivilopediaText)")
//<<<<BUGFfH: End Modify
//FfH: End Add
//>>>>BUGFfH: Added by Denev 2009/09/21
		.def("getImprovementYieldHelp", &CyGameTextMgr::getImprovementYieldHelp, "wstring (int iImprovement, bool bCivilopediaText)")
//<<<<BUGFfH: End Add
