...
bool CyTeam::hasMasteredTech(int /*TechTypes*/ eTech) const
{
	return m_pTeam ? m_pTeam->hasMasteredTech((TechTypes)eTech) : -1;
}
...
/**						                                            							**/
/*************************************************************************************************/
bool CyTeam::isHasCorporationSupport(int eCorporation) const
{
	return m_pTeam ? m_pTeam->isHasCorporationSupport((CorporationTypes)eCorporation) : -1;
}
void CyTeam::setHouseErebus( bool bNewValue)
{
	if( m_pTeam )
		m_pTeam->setHouseErebus(bNewValue);
}
bool CyTeam::isHouseErebus() const 
{
	return m_pTeam ? m_pTeam->isHouseErebus() : -1;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/