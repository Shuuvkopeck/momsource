...
//>>>>	BUGFfH: Added by Denev 2009/10/13
		.def("ctrlKey", &CyGame::ctrlKey, "bool ()")
		.def("altKey", &CyGame::altKey, "bool ()")
//<<<<	BUGFfH: End Add

/*************************************************************************************************/
/**	ADDON (Mercenaries) Sephi	        								                    	**/
/*************************************************************************************************/
        .def("getMercenariesSupportTarget", &CyGame::getMercenariesSupportTarget, "int ()")
        .def("setMercenariesSupportTarget", &CyGame::setMercenariesSupportTarget, "void (int)")
        .def("getMercenariesWarTarget", &CyGame::getMercenariesWarTarget, "int ()")
        .def("setMercenariesWarTarget", &CyGame::setMercenariesWarTarget, "void (int)")
        .def("getPiecesOfBarnaxusCounter", &CyGame::getPiecesOfBarnaxusCounter, "int ()")
        .def("getDevilGatesCreated", &CyGame::getDevilGatesCreated, "int ()")
        .def("changeDevilGatesCreated", &CyGame::changeDevilGatesCreated, "void (int)")
		.def("getImprovementMemory", &CyGame::getImprovementMemory, "int (int)")
		.def("setImprovementMemory", &CyGame::setImprovementMemory, "void (int, int)")
/*************************************************************************************************/
/**			        						END													**/
/*************************************************************************************************/
