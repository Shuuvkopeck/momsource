...
/*************************************************************************************************/
        ...
        .def("getImpInfrastructureHalfCost", &CvCivilizationInfo::getImpInfrastructureHalfCost, "int ()")
        .def("getFlavorScreenImage", &CvCivilizationInfo::getFlavorScreenImage, "wstring ()")
        .def("getFlavorCityScreenImage", &CvCivilizationInfo::getFlavorCityScreenImage, "wstring ()")
        .def("getDefaultUnit", &CvCivilizationInfo::getDefaultUnit, "int ()")		
        .def("isCivicAllowed", &CvCivilizationInfo::isCivicAllowed, "bool ()")				
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		;
...
//FfH: End Add
	...
	python::class_<CvImprovementInfo, python::bases<CvInfoBase> >("CvImprovementInfo")
		...
		.def("isFloodPlainsMakesValid", &CvImprovementInfo::isFloodPlainsMakesValid, "bool ()")
...
//FfH: Added by Kael 09/27/2007
		...
		.def("getImprovementClassType", &CvImprovementInfo::getImprovementClassType, "int ()")
//FfH: End Add
...
//<<<<BUGFfH: End Add
		.def("getMinWilderness", &CvImprovementInfo::getMinWilderness, "int ()")
		.def("getMaxWilderness", &CvImprovementInfo::getMaxWilderness, "int ()")
		// Arrays
...
//>>>>BUGFfH: Added by Denev 2009/09/24
		.def("getFreePromotion", &CvBonusInfo::getFreePromotion, "int ()")
		.def("getMutateChance", &CvBonusInfo::getMutateChance, "int ()")
//<<<<BUGFfH: End Add
//>>>>	Advanced Rules: Added by Denev 2009/12/30
		.def("isModifierPerBonus", &CvBonusInfo::isModifierPerBonus, "bool ()")
//<<<<	Advanced Rules: End Add
		.def("getMinWilderness", &CvBonusInfo::getMinWilderness, "int ()")
		.def("getMaxWilderness", &CvBonusInfo::getMaxWilderness, "int ()")
		.def("getCityYieldModifierType", &CvBonusInfo::getCityYieldModifierType, "int ()")
...
//>>>>BUGFfH: Added by Denev 2009/10/07
		...
		.def("getRequireResist", &CvFeatureInfo::getRequireResist, "int ()")
//<<<<BUGFfH: End Add
