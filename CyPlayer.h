...
public:
	...
	int getResistHostileTerraforming();
...
/*************************************************************************************************/
	...
	bool canSupportMoreUnits() const;
    ...
    bool AI_isWillingToTalk(int ePlayer) const;
...
/** Allow Python to modify the CivilizationType of a Player **/
	...
	bool canIncreaseCityInfrastructureLevel(CyCity* pCity) const;
...
/** Mana **/
    ...
    int getFaith() const;
    void changeFaith(int change);
    int getArcane() const;
    void changeArcane(int change);
    int getArcaneNeeded(int iTech) const;
	int calculateArcaneByBuildings() const;
	int calculateArcaneByManaSchool(int iManaSchool) const;
	void setSpellResearchFocus(int iChange);
	int getSpellResearchFocus() const;
	bool canSpellResearchNext(int eSpellResearch) const;
	...
	bool canGetCulturalAchievement(int iTech) const;
...
/**						                                            							**/
/*************************************************************************************************/
    int getCorporationSupport(int eCorporation) const;
	void changeCorporationSupport(int eCorporation, int change);

    int getCorporationSupportMultiplier(int eCorporation) const;
	void changeCorporationSupportMultiplier(int eCorporation, int change);

	bool isHasCorporationSupport(int eCorporation) const;
	void setHasCorporationSupport(int eCorporation, bool bNewValue);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
