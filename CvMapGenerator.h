...
//FfH: Added by Kael 10/04/2008
	DllExport void addImprovements();													// Exposed to Python
	DllExport void addUniqueImprovements();													// Exposed to Python
//FfH: End Add
	void addDeepOcean();
	void addUniqueManaLocations();
	void addUniqueManaLocation(ImprovementTypes eImprovement);
