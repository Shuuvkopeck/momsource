...
void CyMapGeneratorPythonInterface()
{
	...
	python::class_<CyMapGenerator>("CyMapGenerator")
		...
		.def("addKelp", &CyMapGenerator::addKelp, "void ()")
...
//FfH: Added by Kael 10/04/2008
		.def("addImprovements", &CyMapGenerator::addImprovements, "void ()")
		.def("addUniqueImprovements", &CyMapGenerator::addUniqueImprovements, "void ()")
//FfH: End Add
