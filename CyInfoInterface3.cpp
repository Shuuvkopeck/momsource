...
//>>>>BUGFfH: Added by Denev 2009/10/07
		...
		.def("getCivilizationYieldType", &CvTerrainInfo::getCivilizationYieldType, "int ()")
//<<<<BUGFfH: End Add
...
//FfH: Added by Kael 10/01/2008
		.def("getPrereqCivilization", &CvProjectInfo::getPrereqCivilization, "int ()")
//FfH: End Add

		.def("getFaithCost", &CvProjectInfo::getFaithCost, "int ()")
		.def("getFaithUpkeep", &CvProjectInfo::getFaithUpkeep, "int ()")
		.def("getManaCost", &CvProjectInfo::getManaCost, "int ()")
		.def("getManaSchoolType", &CvProjectInfo::getManaSchoolType, "int ()")
		.def("getSummonUnitType", &CvProjectInfo::getSummonUnitType, "int ()")
		.def("getDevilSummon", &CvProjectInfo::getDevilSummon, "int ()")
		.def("getNumTerrainChanges", &CvProjectInfo::getNumTerrainChanges, "int ()")
		.def("isGlobalEnchantment", &CvProjectInfo::isGlobalEnchantment, "bool ()")
		.def("isHostile", &CvProjectInfo::isHostile, "bool ()")
		.def("isHostileTerraform", &CvProjectInfo::isHostileTerraform, "bool ()")
		.def("getPrereqReligion", &CvProjectInfo::getPrereqReligion, "int ()")
...
/**						                                            							**/
/*************************************************************************************************/
        .def("getReligionHero1", &CvReligionInfo::getReligionHero1, "UnitClassTypes ()")
        .def("getReligionHero2", &CvReligionInfo::getReligionHero2, "UnitClassTypes ()")
        .def("getReligionTech1", &CvReligionInfo::getReligionTech1, "TechTypes ()")
        .def("getReligionTech2", &CvReligionInfo::getReligionTech2, "TechTypes ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		// Arrays
...
//FfH: Added by Kael 10/11/2007
		.def("isSelectable", &CvTraitInfo::isSelectable, "int (int i)")
//FfH: End Add
/*************************************************************************************************/
/**	ADDON (New Functions Definition) Sephi                                     					**/
/*************************************************************************************************/
		.def("isCultureTrait", &CvTraitInfo::isCultureTrait, "bool ()")
		.def("getPrereqTrait", &CvTraitInfo::getPrereqTrait, "int ()")
		.def("getPyPerTurn", &CvTraitInfo::getPyPerTurn, "string ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
        .def("getCorporationSupport", &CvTraitInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvTraitInfo::getCorporationSupportMultiplier, "int (int i)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		;
...
/*************************************************************************************************/
	...
	python::class_<CvEraInfo, python::bases<CvInfoBase> >("CvEraInfo")
		...
		.def("getBaseTechCost", &CvEraInfo::getBaseTechCost, "int () -")
		.def("getBaseSpellresearchCost", &CvEraInfo::getBaseSpellresearchCost, "int () -")
