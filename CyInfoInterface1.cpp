...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvTechInfo, python::bases<CvInfoBase> >("CvTechInfo")
		...
		.def("isHolyKnowledge", &CvTechInfo::isHolyKnowledge, "bool ()")
...
/*************************************************************************************************/
        .def("getCorporationSupport", &CvTechInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvTechInfo::getCorporationSupportMultiplier, "int (int i)")
		.def("isSpellResearch", &CvTechInfo::isSpellResearch, "bool ()")
		.def("getSpellSchool", &CvTechInfo::getSpellSchool, "int ()")
		.def("isTemporaryTech", &CvTechInfo::isTemporaryTech, "bool ()")
		.def("getReligionType", &CvTechInfo::getReligionType, "int ()")
		.def("isAllowAnimalTaming", &CvTechInfo::isAllowAnimalTaming, "bool ()")
		.def("isAllowGuild", &CvTechInfo::isAllowGuild, "bool ()")
		.def("isAllowReligion", &CvTechInfo::isAllowReligion, "bool ()")
		.def("isGuild", &CvTechInfo::isGuild, "bool ()")
		.def("isReligion", &CvTechInfo::isReligion, "bool ()")
		.def("isCulturalAchievement", &CvTechInfo::isCulturalAchievement, "bool ()")
		.def("isDrawNoOrPrereqArrows", &CvTechInfo::isDrawNoOrPrereqArrows, "bool ()")
		.def("isDrawNoAndPrereqArrows", &CvTechInfo::isDrawNoAndPrereqArrows, "bool ()")
		.def("getArcaneAuraPromotion", &CvTechInfo::getArcaneAuraPromotion, "int ()")		
		.def("getPrereqBonus", &CvTechInfo::getPrereqBonus, "int ()")
		.def("getPreferredAlignment", &CvTechInfo::getPreferredAlignment, "int ()")
		.def("getBlockedbyAlignment", &CvTechInfo::getBlockedbyAlignment, "int ()")
		.def("getPyRequirement", &CvTechInfo::getPyRequirement, "string ()")
		.def("getPicture", &CvTechInfo::getPicture, "string ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		;
...
//FfH: Added by Kael 08/17/2007
		...
		.def("getPromotionPrereqOr5", &CvPromotionInfo::getPromotionPrereqOr5, "int ()")
		.def("getPromotionPrereqOr6", &CvPromotionInfo::getPromotionPrereqOr6, "int ()")
		...
		.def("isDisplayAsEquipment", &CvPromotionInfo::isDisplayAsEquipment, "bool ()")
		.def("isDisplayAsClass", &CvPromotionInfo::isDisplayAsClass, "bool ()")		
...
//FfH: End Add
// new Promotions Add Sephi
		.def("isGear", &CvPromotionInfo::isGear, "bool ()")
		.def("isClassPromotion", &CvPromotionInfo::isClassPromotion, "bool ()")
		.def("isDiscipline", &CvPromotionInfo::isDiscipline, "bool ()")
		.def("isGainedInBattle", &CvPromotionInfo::isGainedInBattle, "bool ()")
		.def("getEquipmentCategory", &CvPromotionInfo::getEquipmentCategory, "int ()")
		.def("getRequiredGameOption", &CvPromotionInfo::getRequiredGameOption, "int ()")
		.def("isPrereqCivilization", &CvPromotionInfo::isPrereqCivilization, "bool ()")
// new Promotions
/*************************************************************************************************/
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/*************************************************************************************************/
        .def("getCorporationSupport", &CvPromotionInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvPromotionInfo::getCorporationSupportMultiplier, "int (int i)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		// Arrays
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		.def("isNoPillage", &CvUnitInfo::isNoPillage, "bool ()")
...
/**						                                            							**/
/*************************************************************************************************/
        .def("isArcaneAura", &CvUnitInfo::isArcaneAura, "bool ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/*************************************************************************************************/
        .def("getCorporationSupport", &CvUnitInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvUnitInfo::getCorporationSupportMultiplier, "int (int i)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//BUGFfH: Added by Denev 2009/09/04
		.def("getUnitButtonWithArtStyle", &CvUnitInfo::getUnitButtonWithArtStyle, "string (int iUnitArtStyle)")
		.def("getUnitButtonWithCivArtStyle", &CvUnitInfo::getUnitButtonWithCivArtStyle, "string (int iCivilization)")
//BUGFfH: End Add
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/*************************************************************************************************/
		.def("getPyPerTurn", &CvCivicInfo::getPyPerTurn, "string ()")
        .def("getCorporationSupport", &CvCivicInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvCivicInfo::getCorporationSupportMultiplier, "int (int i)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**	ADDON Sephi			                                 					**/
/*************************************************************************************************/
        .def("getCorporationSupport", &CvBuildingInfo::getCorporationSupport, "int (int i)")
        .def("getCorporationSupportMultiplier", &CvBuildingInfo::getCorporationSupportMultiplier, "int (int i)")
        .def("isDistrict", &CvBuildingInfo::isDistrict, "bool ()")
        .def("isEnchantment", &CvBuildingInfo::isEnchantment, "bool ()")
		.def("getPrereqBuildingClass", &CvBuildingInfo::getPrereqBuildingClass, "int ()")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
		// Arrays
