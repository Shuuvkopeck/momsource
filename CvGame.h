...
public:
	...
	int getDivineJudgementTotalTurnReq() const;
...
//FfH: Added by Kael 08/04/2007
    ...
    int getTrueMaxGlobalCounter() const;
...
//<<<<	BUGFfH: End Add
	...
	void createBarbarianCities();  // moved from Protected here

/*************************************************************************************************/
/**	ADDON (Mercenaries) Sephi	        								                    	**/
/*************************************************************************************************/
    int getMercenariesSupportTarget() const;
    void setMercenariesSupportTarget(int iNewTarget);
    int getMercenariesWarTarget() const;
    void setMercenariesWarTarget(int iNewTarget);

	void changePiecesOfBarnaxusCounter(int iChange); 
	int getPiecesOfBarnaxusCounter() const;

	int getDevilGatesCreated() const;
	void changeDevilGatesCreated(int iChange);

	int getImprovementMemory(int iImprovementMemory) const;
	void setImprovementMemory(int iImprovementMemory, int iNewValue);

	void doGlobalEnchantments();
	int getUnitPerTileLimit() const;
	int getOpenPlayer() const;
	void createHolyCities();
	int getHolyCitiesCreatedTurn() const;
	ThreadOrganizer& getThreadOrganizer();
	int testParallelFor(int i); // Only for Testing !!!
/*************************************************************************************************/
/**			        						END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
//FfH: Added by Kael 08/07/2007
	...
	int m_iFlexibleDifficultyCounter;
...
//FfH: End Add
	ThreadOrganizer m_ThreadOrganizer;
/*************************************************************************************************/
/**	ADDON (Mercenaries) Sephi	        								                    	**/
/*************************************************************************************************/
    int m_iMercenariesSupportTarget;
    int m_iMercenariesWarTarget;

	int m_iPiecesOfBarnaxusCounter;
	int m_iDevilGatesCreated;
	int* m_paiImprovementMemory;
/*************************************************************************************************/
/**			        						END													**/
/*************************************************************************************************/
