...
//	DllExport void parseTraits(CvWStringBuffer &szHelpString, TraitTypes eTrait, CivilizationTypes eCivilization = NO_CIVILIZATION, bool bDawnOfMan = false);
	DllExport void parseTraits(CvWStringBuffer &szHelpString, TraitTypes eTrait, CivilizationTypes eCivilization = NO_CIVILIZATION, bool bTemporary = false, bool bCivilopediaText = false);
//<<<<BUGFfH: End Modify


//FfH: Added by Kael 08/08/2007
    DllExport void parseLeaderTraits(CvWStringBuffer &szInfoString, PlayerTypes ePlayer = NO_PLAYER);
//FfH: End Add
	void parseCivilizationAbilities(CvWStringBuffer &szInfoString, PlayerTypes ePlayer = NO_PLAYER);
	void CivilizationAbilititesHelp(CvWStringBuffer &szHelpString, CivilizationTypes eCivilization);
	...
	void parseEquipmentHelp(CvWStringBuffer &szBuffer, PromotionTypes ePromotion, const wchar* pcNewline = NEWLINE);
//FfH: Added by Kael 08/08/2007
...
//FfH: Added by Kael 07/23/2007
	DllExport void setSpellHelp(CvWStringBuffer &szBuffer, SpellTypes eSpell, bool bCivilopediaText = false);
//FfH: End Add
...
//>>>>BUGFfH: Added by Denev 2009/09/21
	void setImprovementYieldHelp(CvWStringBuffer &szBuffer, ImprovementTypes eImprovement, bool bCivilopediaText = false);
	bool buildBonusEnableString( CvWStringBuffer& szBuffer, TechTypes eTech, int iBonusType, bool bFirst, bool bList = false, bool bPlayerContext = false );

	const CvWString CvGameTextMgr::getLinkedText(BonusTypes eBonus,					bool bColor = true, bool bLinks = true, bool bFontIcon = true) const;
	const CvWString CvGameTextMgr::getLinkedText(BuildingClassTypes eBuildingClass,	bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(BuildingTypes eBuilding,			bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(CivicTypes eCivic,					bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(CivilizationTypes eCivilization,	bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(CorporationTypes eCorporation,		bool bColor = true, bool bLinks = true, bool bFontIcon = true) const;
	const CvWString CvGameTextMgr::getLinkedText(DomainTypes eDomain,				bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(FeatureTypes eFeature,				bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(ImprovementTypes eImprovement,		bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(LeaderHeadTypes eLeaderHead,		bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(ProcessTypes eProcess,				bool bColor = true, bool bLinks = true, bool bFontIcon = true) const;
	const CvWString CvGameTextMgr::getLinkedText(ProjectTypes eProject,				bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(PromotionTypes ePromotion,			bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(ReligionTypes eReligion,			bool bColor = true, bool bLinks = true, bool bFontIcon = true) const;
	const CvWString CvGameTextMgr::getLinkedText(SpecialistTypes eSpecialist,		bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(SpellTypes eSpell,					bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(TechTypes eTech,					bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(TerrainTypes eTerrain,				bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(TraitTypes eTrait,					bool bColor = true, bool bLinks = true, bool bTemp = false) const;
	const CvWString CvGameTextMgr::getLinkedText(UnitCombatTypes eUnitCombat,		bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(UnitClassTypes eUnitClass,			bool bColor = true, bool bLinks = true) const;
	const CvWString CvGameTextMgr::getLinkedText(UnitTypes eUnit,					bool bColor = true, bool bLinks = true) const;

	void getAvailableCivs(std::list<CivilizationTypes>& aeAvailableCiv, BuildingTypes eBuilding, CivilizationTypes eActiveCiv = NO_CIVILIZATION);
	void getAvailableCivs(std::list<CivilizationTypes>& aeAvailableCiv, UnitTypes eUnit, CivilizationTypes eActiveCiv = NO_CIVILIZATION);
/*************************************************************************************************/
/**	ADDON (New Mana) Sephi                                                   					**/
/*************************************************************************************************/
    void setManaStr(CvWString& szString, PlayerTypes ePlayer);
    void setUnitSupportStr(CvWString& szString, PlayerTypes ePlayer);	
    void setFaithStr(CvWString& szString, PlayerTypes ePlayer);
    void setArcaneStr(CvWString& szString, PlayerTypes ePlayer);
	void setGlobalCultureStr(CvWString& szString, PlayerTypes ePlayer);
	void setGlobalYieldStr(CvWString& szString, PlayerTypes ePlayer, int iYieldType);
	void setCombatAuraStr(CvWString& szString, CvCombatAura* pAura, const CvUnit* pUnit, int iType);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
//<<<<	BUGFfH: End Add
...
// Better AI Debug (Skyre)
	const wchar* getGroupflagName(int iGroupflag) const;
// End Better AI Debug
};
