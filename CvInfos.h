...
public:
	...
	bool isHolyKnowledge() const;							// Exposed to Python
...
//FfH Techs: Added by Kael 08/09/2007
	bool isWater() const;
    int getPreferredAlignment() const;
    int getBlockedbyAlignment() const;
...
/**						                                            							**/
/*************************************************************************************************/
    int getCorporationSupport(int iCorporation) const;
    int getCorporationSupportMultiplier(int iCorporation) const;

	int getCorporationSupportVectorSize();
	CvString getCorporationSupportNamesVectorElement(int i);
	int getCorporationSupportValuesVectorElement(int i);

	int getCorporationSupportModVectorSize();
	CvString getCorporationSupportModNamesVectorElement(int i);
	int getCorporationSupportModValuesVectorElement(int i);

	bool isSpellResearch() const;
	int getSpellSchool() const;
	int getSpellResearchLevel();

	bool isTemporaryTech();
	int getReligionType();
	bool isAllowAnimalTaming() const;
	bool isAllowGuild() const;
	bool isAllowReligion() const;
	bool isGuild() const;
	bool isReligion() const;
	bool isCulturalAchievement() const;
	bool isDrawNoOrPrereqArrows();
	bool isDrawNoAndPrereqArrows();

	int getArcaneAuraPromotion() const;
	int getNumPrereqSpellResearchFromSameSchool() const;
	int getSpellDamageChange(int iDamagetype) const;
	...
	bool isIncreaseTerraformTiles() const;
	bool isIncreaseHostileTerraformTiles() const;
	int getIncreaseSummonXP() const;
	int getIncreaseMaxMana() const;
	int getIncreaseMana() const;
	int getIncreaseManaFromNodes() const;
	int getIncreaseStrengthOfRegularUnits() const;
	int getPrereqBonus() const;

	const TCHAR* getPyRequirement() const;
	const TCHAR* getPicture() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
	std::vector<CvString> m_aszExtraXML1forPass3;
    ...
    std::vector<CvString> m_aszCorporationSupportforPass3;
	std::vector<int> m_aiCorporationSupportforPass3;

    std::vector<CvString> m_aszCorporationSupportModforPass3;
	std::vector<int> m_aiCorporationSupportModforPass3;

	int m_iReligionType;
	bool m_bAllowAnimalTaming;
	bool m_bAllowGuild;
	bool m_bAllowReligion;
	bool m_bGuild;
	bool m_bReligion;
	bool m_bCulturalAchievement;
	bool m_bDrawNoOrPrereqArrows;
	bool m_bDrawNoAndPrereqArrows;
	int m_iArcaneAuraPromotion;
	int m_iNumPrereqSpellResearchFromSameSchool;
	int m_iWillpowerChange;
	int m_iReducedTerraformCost;
	int m_iReducedEnchantmentCost;
	int m_iReducedSummonCost;
	bool m_bIncreaseTerraformTiles;
	bool m_bIncreaseHostileTerraformTiles;
	int m_iIncreaseSummonXP;
	int m_iIncreaseMaxMana;
	int m_iIncreaseMana;
	int m_iIncreaseManaFromNodes;
	int m_iIncreaseStrengthOfRegularUnits;
	int m_iPrereqBonus;

	CvString m_szPyRequirement;
	CvString m_szPicture;

	int* m_paiSpellDamageChanges;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
public:
	...
	bool isMakeEquipmentDurabilityValid(int i) const;
/*************************************************************************************************/
/**	ADDON (new Functions Definitions) Sephi					                     				**/
/*************************************************************************************************/
	bool isPromotionAPrereq(int iPromotion) const;
/** Equipment Start **/
	bool isGear() const;
	bool isClassPromotion() const;
	bool isDiscipline() const;
	bool isGainedInBattle() const;
/** Equipment End   **/
	int getAdventurePrereq() const;
	int getAdventurePrereqVectorSize();
	CvString getAdventurePrereqVectorElement(int i);
	int getCombatAuraEffect() const;
	int getCombatAuraRange() const;
	int getCombatAuraTargets() const;
	bool isAnyUnitCombat() const;

	bool isCannotLeaveCulture() const;
	bool isLimitedByNumberBonuses() const;
	bool isNoXP() const;
	bool isFlamingArrows() const;
	bool isHeroPromotion() const;
	int getGoldCost() const;
	int getManaCost() const;
	int getFaithCost() const;
	int getIDWPercent() const;
	int getUnitClassCreateFromCombat() const;
	int getUnitClassCreateFromCombatChance() const;
	int getEquipmentCategory() const;
	int getEquipmentLevel() const;
	int getDurabilityType() const;

	int getEquipmentYieldType() const;
	int getYieldCostType() const;
	int getYieldCost(int iUnitTier) const;
	int getReducedManaCost() const;
	int getBonusVSUnitsFullHealth() const;

	int getUnitCombatTarget() const;
    ...
    int getNumPromotionMustHave() const;
    PromotionTypes getPromotionMustHave(int iI) const;
	...
	bool isPrereqCivilization(int iCivilization) const;

	bool isCombatAuraImmunityRangedStrike() const;
	bool isCombatAuraLoyaltyChange() const;
	bool isCombatAuraImmuneToFearChange() const;
	bool isCombatAuraWaterwalking() const;
	bool isCombatAuraEnchantedWeapons() const;
	int getCombatAuraExperienceChange() const;
	int getCombatAuraFearEffectChange() const;
	int getCombatAuraIgnoreFirstStrikes() const;
	int getCombatAuraIncreaseFirstStrikes() const;
	int getCombatAuraCityAttackChange() const;
	int getCombatAuraHealthRegenerationChange() const;
	int getCombatAuraStrengthChange() const;
	int getCombatAuraCaptureChanceChange() const;
	int getCombatAuraEnslaveChanceChange() const;
	int getCombatAuraType() const;
	int getCombatAuraTypeVectorSize();
	CvString getCombatAuraTypeVectorElement(int i);

	int getPromotionFromCombat() const;
	int getPromotionFromCombatVectorSize();
	CvString getPromotionFromCombatVectorElement(int i);

	bool isCombatAuraApplyPromotion(int iI) const;
	bool isCombatAuraRemovePromotion(int iI) const;
	int getCombatAuraApplyPromotionVectorSize();
	CvString getCombatAuraApplyPromotionNamesVectorElement(int i);
	bool getCombatAuraApplyPromotionValuesVectorElement(int i);
	int getCombatAuraRemovePromotionVectorSize();
	CvString getCombatAuraRemovePromotionNamesVectorElement(int i);
	bool getCombatAuraRemovePromotionValuesVectorElement(int i);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int getRequiredGameOption() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
//<<<<Refined Defensive Strikes: End Add
    bool isEquipmentPromotion(int iPromotion) const;
	bool isDisplayAsEquipment();
	bool isDisplayAsClass();
	int getEquipmentPromotionsVectorSize();
	CvString getEquipmentPromotionsNamesVectorElement(int i);
	bool isEquipmentPromotionsValuesVectorElement(int i);
/*************************************************************************************************/
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/**																								**/
/**						                                            							**/
...
//FfH: Added by Kael 07/30/2007
	...
	int getCombatAuraDamageTypeResist(int i) const;
	bool readPass3();
//FfH: End Add
...
/** Equipment Start **/
	bool m_bGear;
/** Equipment End   **/
	bool m_bClassPromotion;
	bool m_bDiscipline;
	bool m_bGainedInBattle;
	int m_iAdventurePrereq;
	int m_iCombatAuraEffect;
	int m_iCombatAuraRange;
	int m_iCombatAuraTargets;
	bool m_bAnyUnitCombat;
	bool m_bCannotLeaveCulture;
	bool m_bLimitedByNumberBonuses;
	bool m_bNoXP;
	bool m_bFlamingArrows;
	bool m_bHeroPromotion;
	int m_iGoldCost;
	int m_iManaCost;
	int m_iFaithCost;
	int m_iIDWPercent;
	int m_iUnitClassCreateFromCombat;
	int m_iUnitClassCreateFromCombatChance;
	int m_iEquipmentCategory;
	int m_iEquipmentLevel;
	int m_iDurabilityType;
	int m_iYieldCost;
	int m_iYieldCostType;
	int m_iEquipmentYieldType;
	int m_iBonusVSUnitsFullHealth;
	int m_iReducedManaCost;
	int m_iUnitCombatTarget;
	int m_iPromotionFromCombat;
	int m_iSpellTargetIncrease;
	int m_iNumPromotionExcludes;
	int m_iNumPromotionReplacedBy;
	int m_iNumPromotionMustHave;
	...
	bool m_bCombatAuraImmunityRangedStrike;
	bool m_bCombatAuraLoyaltyChange;
	bool m_bCombatAuraImmuneToFearChange;
	bool m_bCombatAuraWaterwalking;
	bool m_bCombatAuraEnchantedWeapons;
	int m_iCombatAuraExperienceChange;
	int m_iCombatAuraFearEffectChange;
	int m_iCombatAuraIgnoreFirstStrikes;
	int m_iCombatAuraIncreaseFirstStrikes;
	int m_iCombatAuraCityAttackChange;
	int m_iCombatAuraHealthRegenerationChange;
	int m_iCombatAuraStrengthChange;
	int m_iCombatAuraCaptureChanceChange;
	int m_iCombatAuraEnslaveChanceChange;
	bool* m_pbCombatAuraApplyPromotion;
	bool* m_pbCombatAuraRemovePromotion;
	std::vector<bool> m_abCombatAuraApplyPromotionsforPass3;
	std::vector<bool> m_abCombatAuraRemovePromotionsforPass3;
	std::vector<CvString> m_aszCombatAuraApplyPromotionsforPass3;
	std::vector<CvString> m_aszCombatAuraRemovePromotionsforPass3;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
//>>>>Refined Defensive Strikes: Added by Denev 2009/11/10
	bool m_bDefensiveStrikes;
//<<<<Refined Defensive Strikes: End Add
    bool* m_pabEquipmentPromotions;
    std::vector<CvString> m_aszEquipmentPromotionsforPass3;
	std::vector<bool> m_abEquipmentPromotionsforPass3;
/*************************************************************************************************/
/**	ADDON (Houses of Erebus) Sephi			                                 					**/
/**																								**/
/**						                                            							**/
...
//FfH: Added by Kael 07/30/2007
	...
	int* m_piCombatAuraDamageTypeResist;
//FfH: End Add
	...
	bool* m_pbUnitCombat;
	bool* m_pbMakeEquipmentDurabilityValid;
...
public:
	...
	int getPromotionPrereq1() const;
	int getPromotionPrereq2() const;
	int getPromotionPrereq3() const;
	int getPromotionPrereq4() const;
...
/*************************************************************************************************/
	...
	int getAddPromotionType4() const;
	int getAddPromotionType5() const;
	int getConvertUnitType() const;
	int getCreateBuildingType() const;
	int getCreateBuildingType1() const;
	int getCreateBuildingType2() const;
	int getRemoveBuildingType() const;
	int getCreateFeatureType() const;
	int getCreateImprovementType() const;
	int getSpreadReligion() const;
	int getImmobileTurns() const;
	int isDomination() const;
...
/**						                                            							**/
/*************************************************************************************************/
    bool isAllowAuto() const;
	bool isObsoletedBySpell(int iSpell) const;
	bool isExploreDungeon() const;
	bool isNoDisplay() const;
	int getFaithCost() const;
	int getManaCost() const;
    int getPrereqAlignment() const;
	bool isTargetedHostile() const;
	bool isBombard() const;
	bool isFlameFeatures() const;
	bool isHighCrit() const;
	bool isManaCostReductionBonus() const;
	bool isThiefMission() const;
	int getThiefDifficulty() const;	
	int getThiefExperienceChange() const;	
	int getThiefRelationsHit() const;
	int getDoT() const;
	int getTriggerSecondaryPlotChance() const;
	int getForcedTeleport() const;	
	int getReduceDurability() const;	
	int getDestroyEnemyEquipment() const;	
	int getNumTargets() const;
	int getDamageSpellPrereqPromotion() const;
	int getDamageSpellPrereqUnitCombat() const;
	int getUnitCombatCapture() const;
	bool isSpellObsoleted(CvUnit* pCaster, int iSpellType) const;
	int getObsoletedBySpellVectorSize();
	CvString getObsoletedBySpellNamesVectorElement(int i);
	bool getObsoletedBySpellValuesVectorElement(int i);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//>>>>BUGFfH: Added by Denev 2009/09/14
	int getTerrainOrPrereq1() const;
	int getTerrainOrPrereq2() const;
	const TCHAR* getPyResultSecondary() const;
//<<<<BUGFfH: End Add
...
protected:
	...
	int m_iPromotionPrereq3;
	int m_iPromotionPrereq4;
	int m_iUnitPrereq;
...
/*************************************************************************************************/
    bool m_bAllowAuto;
	bool m_bExploreDungeon;
	bool m_bNoDisplay;
	int m_iFaithCost;
	int m_iManaCost;
    int m_iPrereqAlignment;
    int m_iInterfaceMode;
	bool m_bTargetedHostile;
	bool m_bBombard;
	bool m_bFlameFeatures;
	bool m_bHighCrit;
	bool m_bManaCostReductionBonus;
	bool m_bThiefMission;
	int m_iThiefDifficulty;
	int m_iThiefExperienceChange;
	int m_iThiefRelationsHit;
	int m_iTriggerSecondaryPlotChance;
	int m_iForcedTeleport;
	int m_iReduceDurability;
	int m_iDestroyEnemyEquipment;
	int m_iDoT;
	int m_iNumTargets;
	int m_iDamageSpellPrereqPromotion;
	int m_iDamageSpellPrereqUnitCombat;
	int m_iUnitCombatCapture;

	bool* m_pbObsoletedBySpell;
    std::vector<CvString> m_aszObsoletedBySpellforPass3;
	std::vector<bool> m_abObsoletedBySpellforPass3;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	...
	int m_iAddPromotionType4;
	int m_iAddPromotionType5;
	...
	int m_iCreateBuildingType1;
	int m_iCreateBuildingType2;
	int m_iRemoveBuildingType;
...
//>>>>BUGFfH: Added by Denev 2009/09/14
	int m_iTerrainOrPrereq1;
	int m_iTerrainOrPrereq2;
	CvString m_szPyResultSecondary;
//<<<<BUGFfH: End Add
//>>>>Spell Interrupt Unit Cycling: Added by Denev 2009/10/17
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvAIPromotionSpecializationInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvAIPromotionSpecializationInfo();
	DllExport virtual ~CvAIPromotionSpecializationInfo();
    ...
    int getDefensiveStrikes() const;
    int getFirstStrikes() const;
    int getGuardsman() const;
    int getHunter() const;
	...
	int getPromotionValue(int i) const;

/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvAIPromotionSpecializationInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvDungeonInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvDungeonInfo();
	DllExport virtual ~CvDungeonInfo();

	void copyNonDefaults(CvDungeonInfo* pClassInfo, CvXMLLoadUtility* pXML);

	void read(FDataStreamBase* stream);
	void write(FDataStreamBase* stream);
	bool read(CvXMLLoadUtility* pXML);

	bool isLairResult(int iLairResult) const;
	int getImprovementType() const;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvUnitCombatInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvUnitCombatInfo();
	DllExport virtual ~CvUnitCombatInfo();
	...
	bool isArcherSupport() const;
	bool isDefensiveBonuses() const;
	bool isCityDefensiveBonuses() const;
	bool isNoPromotions() const;
	int getCityAttack() const;
...
protected:
	...
	bool m_bArcherSupport;
	bool m_bDefensiveBonuses;
	bool m_bCityDefensiveBonuses;
	bool m_bNoPromotions;
	int m_iCityAttack;
	int m_iWithdrawal;
};
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvDungeonEventInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvDungeonEventInfo();
	DllExport virtual ~CvDungeonEventInfo();

	void copyNonDefaults(CvDungeonEventInfo* pClassInfo, CvXMLLoadUtility* pXML);
	...
	bool isThreaten() const;
	bool isTaunt() const;
	bool isConvert() const;
	bool isDonateUnits() const;
	int getGold() const;
	...
	bool isPrereqAttitude(int i) const;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvLairResultInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvLairResultInfo();
	DllExport virtual ~CvLairResultInfo();

	void copyNonDefaults(CvLairResultInfo* pClassInfo, CvXMLLoadUtility* pXML);
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvDurabilityInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvDurabilityInfo();
	DllExport virtual ~CvDurabilityInfo();

	void copyNonDefaults(CvDurabilityInfo* pClassInfo, CvXMLLoadUtility* pXML);
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvEquipmentCategoryInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvEquipmentCategoryInfo();
	DllExport virtual ~CvEquipmentCategoryInfo();

	void copyNonDefaults(CvEquipmentCategoryInfo* pClassInfo, CvXMLLoadUtility* pXML);
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvCityStateInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvCityStateInfo();
	DllExport virtual ~CvCityStateInfo();

	void copyNonDefaults(CvCityStateInfo* pClassInfo, CvXMLLoadUtility* pXML);
	...
	int getNativeFeature() const;
	int getNativeImprovement() const;
...
protected:
	...
	int m_iReligionType;
	bool m_bCoastal;
	int m_iNativeFeature;
	int m_iNativeImprovement;
	int m_iNativeTerrain;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvPlaneInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvPlaneInfo();
	DllExport virtual ~CvPlaneInfo();

	void copyNonDefaults(CvPlaneInfo* pClassInfo, CvXMLLoadUtility* pXML);

	void read(FDataStreamBase* stream);
	void write(FDataStreamBase* stream);
	bool read(CvXMLLoadUtility* pXML);

	int getNativeTerrainType(int iTerrainClass) const;
	int getNativeFeatureType(int iFeatureClass) const;
	bool isReplaceWaterWithPeaks() const;
	bool isGoodies() const;
	bool isNoRiver() const;
	bool isBonusSpawn(int iBonus) const;
//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------

protected:

	int* m_iNativeTerrainTypes;
	int* m_iNativeFeatureTypes;
	bool* m_pbBonusSpawn;
	bool m_bReplaceWaterWithPeaks;
	bool m_bGoodies;
	bool m_bNoRiver;
};
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvTerrainClassInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvTerrainClassInfo();
	DllExport virtual ~CvTerrainClassInfo();

	void copyNonDefaults(CvTerrainClassInfo* pClassInfo, CvXMLLoadUtility* pXML);
	...
	int getDefaultTerrainIndex() const;
	void setDefaultTerrainIndex(int i);
//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------

protected:

	int m_iDefaultTerrainIndex;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvFeatureClassInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvFeatureClassInfo();
	DllExport virtual ~CvFeatureClassInfo();

	void copyNonDefaults(CvFeatureClassInfo* pClassInfo, CvXMLLoadUtility* pXML);
	...
	int getDefaultFeatureIndex() const;
	void setDefaultFeatureIndex(int i);
//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------

protected:

	int m_iDefaultFeatureIndex;
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvCitySpecializationInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvCitySpecializationInfo();
	DllExport virtual ~CvCitySpecializationInfo();

	void copyNonDefaults(CvCitySpecializationInfo* pClassInfo, CvXMLLoadUtility* pXML);
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvAdventureInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvAdventureInfo();
	DllExport virtual ~CvAdventureInfo();

	bool isDisabled() const;
    bool isVictory() const;
    bool isVictoryFailed() const;
    int getPrereqAC() const;
    bool isPrereqLeader(int iLeader) const;
    bool isPrereqCiv(int iCiv) const;
    bool isPrereqCivMet(int iCiv) const;
    bool isPrereqReligionFounded(int iReligion) const;
    int getAdventureCounter(int iNumber) const;
    int getAdventureStep(int iNumber) const;
	const TCHAR* getPyIsFinished() const;

/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvAdventureInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
protected:
    bool m_bDisabled;
    bool m_bVictory;
    bool m_bVictoryFailed;
    int  m_iPrereqAC;

    int* m_piAdventureCounters;

    bool* m_pbPrereqLeaders;
    bool* m_pbPrereqCivs;
    bool* m_pbPrereqCivsMet;
    bool* m_pbPrereqReligionsFounded;

	CvString m_szPyIsFinished;
};
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvAdventureStepInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvAdventureStepInfo();
	DllExport virtual ~CvAdventureStepInfo();

    bool isCivsDestroyed() const;
	bool isImprovementPillaged() const;
	bool isNoBarBarian() const;
	bool isUnitCreated() const;
	bool isUnitKill() const;
	bool isTroophyFromAnimal() const;
	int getUnitType() const;

    bool isCastAnySpell() const;
    bool isCivicDuration() const;
    bool isDestroyCivilization() const;
    bool isDiscoverWholeMap() const;
    bool isGovannonsLegacy() const;
    bool isGlobalEnchantment() const;
    bool isMazatlAmbushDeepJungle() const;
    bool isNeverAdoptCivic() const;
    bool isSheaimSummonDemon() const;
    bool isSpell() const;
    bool isSpreadFeature() const;
    bool isUnitPromoted() const;
    int getACabove() const;
    int getACbelow() const;
    int getCivicType() const;
    int getCivilizationType() const;
    ...
    int getRazeHolyCity() const;
    int getSpellType() const;
	int getUnitLevel() const;

    bool isMimicPromotion() const;
    int getNumBuildingOwned() const;
    int getBuildingType() const;

    bool isSpreadReligion() const;
    bool isKillHeroNetherblade() const;
    bool isPaxPatria() const;
    bool isWorldUnitDefeated() const;
	bool isCreateWorldWonder() const;
    bool isLeadOvercouncil() const;
    bool isLeadUndercouncil() const;
    bool isDeclareWarAtFriendly() const;
    bool isNeverLooseCity() const;
    bool isConvertAllCivs() const;
    bool isDeclareWar() const;

    int getCapitalPopulation() const;
    int getGoldTreasury() const;
    int getUnitCount() const;
    int getNumUnitsOwned() const;
    int getNumBonusOwned() const;
    int getBonusType() const;

    bool isRemoveReligionFromAllCities() const;
    bool isLanunCaptureShip() const;
    bool isPlunderGold() const;

/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvAdventureStepInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
protected:
    bool m_bCivsDestroyed;
	bool m_bImprovementPillaged;
	bool m_bNoBarBarian;
	bool m_bUnitCreated;
	bool m_bUnitKill;
	bool m_bTroophyFromAnimal;
	int m_iUnitType;

    bool m_bCastAnySpell;
    bool m_bCivicDuration;
    bool m_bDestroyCivilization;
    bool m_bDiscoverWholeMap;
	bool m_bGlobalEnchantment;
    bool m_bGovannonsLegacy;
    bool m_bMazatlAmbushDeepJungle;
    bool m_bNeverAdoptCivic;
    bool m_bSheaimSummonDemon;
    bool m_bSpell;
    bool m_bSpreadFeature;
    bool m_bUnitPromoted;
    int m_iACabove;
    int m_iACbelow;
    int m_iCivicType;
    int m_iCivilizationType;
    ...
    bool m_bMimicPromotion;
    int m_iNumBuildingOwned;
    int m_iBuildingType;

    bool m_bSpreadReligion;
    bool m_bKillHeroNetherblade;
    bool m_bPaxPatria;
    bool m_bWorldUnitDefeated;
	bool m_bCreateWorldWonder;
    bool m_bLeadOvercouncil;
    bool m_bLeadUndercouncil;
    bool m_bDeclareWarAtFriendly;
    bool m_bNeverLooseCity;
    bool m_bConvertAllCivs;
    bool m_bDeclareWar;

    int m_iCapitalPopulation;
    int m_iGoldTreasury;
    int m_iUnitCount;
    int m_iNumUnitsOwned;
    int m_iNumBonusOwned;
    int m_iBonusType;

    bool m_bRemoveReligionFromAllCities;
    bool m_bLanunCaptureShip;
    bool m_bPlunderGold;
...
class CvManaschoolInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvManaschoolInfo();
	DllExport virtual ~CvManaschoolInfo();

	int getBonusSummonStrength() const;
	int getBonusReducedTerraformCost() const;
	int getBonusIncreasedSpellResearch() const;
	int getBonusReducedGlobalEnchantment() const;
	int getBonusIncreasedTerraformEffect() const;
	int getBonusIncreasedMana() const;

	const TCHAR* getPicture() const;

    bool isBonusLinked(int iBonus) const;
    int getTechLevel(int iTech) const;
    int getSpellResearchAlignmentMod(int iAlignment) const;
/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvManaschoolInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	void read(FDataStreamBase* stream);
...
protected:
	...
	int m_iBonusReducedTerraformCost;
	int m_iBonusIncreasedSpellResearch;
	int m_iBonusReducedGlobalEnchantment;
	int m_iBonusIncreasedTerraformEffect;
	int m_iBonusIncreasedMana;

	CvString m_szPicture;

    bool* m_pbBonusLinked;
    int* m_piTechLevel;
    int* m_piSpellResearchAlignmentMod;
};

/**	ADDON (Combatauras) Sephi																	**/

class CvCombatAuraInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvCombatAuraInfo();
	DllExport virtual ~CvCombatAuraInfo();

	bool isBlessing() const;
	bool isPrereqAlive() const;
	int getStrength() const;
    int getFear() const;
	int getCombatAuraClassType() const;
	int getPrereqPromotion() const;
	int getPrereqUnitClass() const;
	int getPrereqUnitCombat() const;
	int getRange() const;
	int getTargets() const;
    int getTier() const;

	int getAlignmentType() const;
	int getAttackAlignmentBonus() const;
	...
	bool isPromotionApply(int iPromotion) const;
	bool isPromotionRemove(int iPromotion) const;

/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvCombatAuraInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	void read(FDataStreamBase* stream);
...
protected:
	...
	int m_iStrength;
    int m_iFear;
	int m_iCombatAuraClassType;
	int m_iPrereqPromotion;
	int m_iPrereqUnitClass;
	int m_iPrereqUnitCombat;

	int m_iRange;
	int m_iTargets;
    int m_iTier;

	int m_iAlignmentType;
	int m_iAttackAlignmentBonus;
	...
	bool* m_pbPromotionApply;
	bool* m_pbPromotionRemove;
};

class CvCombatAuraClassInfo :	public CvHotkeyInfo
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	DllExport CvCombatAuraClassInfo();
	DllExport virtual ~CvCombatAuraClassInfo();

/*************************************************************************************************/
/**	TrueModular								05/26/09	Written: Mr. Genie	Imported: Xienwolf	**/
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	void copyNonDefaults(CvCombatAuraClassInfo* pClassInfo, CvXMLLoadUtility* pXML);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	void read(FDataStreamBase* stream);
...
public:
	...
	int getCaptureDifficulty() const;				// Exposed to Python
	...
	bool isNoPillage() const;				// Exposed to Python
	bool isSpy() const;				// Exposed to Python
	bool isCanUpgradeManaNodes() const;				
...
/*************************************************************************************************/
    ...
    bool isBarbarianSpawn() const;
	bool isWildmanaGuardian() const;
	bool isArcaneAura() const;
	int getObsoleteTech( void ) const;
    int getBonusAptitude(int i) const;
    int getArcaneRange() const;
    int getAppearanceProb() const;
    int getAppearanceTechs(int i) const;
	int getCityCommerceChanges(int i) const;
	int getUpgradeCivVectorSize();
	CvString getUpgradeCivVectorElement(int i);
	int getPrereqCivVectorSize();
	CvString getPrereqCivVectorElement(int i);
	int getFaithUpkeep();
	int getManaUpkeep();
	int getCombatAuraType();
	int getReducedCostByYieldOverwrite() const;
	int getReducedCostByYield() const;
	int getPopulationCost() const;
	int getGlobalYieldTypeCost() const;
	int getGlobalYieldCost() const;
	int getExtraLives() const;
	int getBonusNearUF() const;
	bool isNoCitySupportNeeded() const;
	int getMinWilderness() const;
	int getMaxWilderness() const;
	bool isCitySupportNeeded() const;
	bool isNoEquipment() const;
	bool isNoXP() const;
	bool isScaleWithTech() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
    int getCorporationSupportNeeded() const;
    int getCorporationSupport(int iCorporation) const;
    int getCorporationSupportMultiplier(int iCorporation) const;
/*************************************************************************************************/
/**	END	                                        												**/
...
//>>>>BUGFfH: Added by Denev 2009/09/04
	const TCHAR* getUnitButtonWithArtStyle(int iUnitArtStyle) const;
	const TCHAR* getUnitButtonWithCivArtStyle(int iCivilization) const;
//<<<<BUGFfH: End Add
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
    ...
    bool m_bBarbarianSpawn;
    bool m_bWildmanaGuardian;
	bool m_bArcaneAura;
	int m_iObsoleteTech;
    int* m_piBonusAptitude;
    int* m_piAppearanceTechs;
    int* m_piCityCommerceChanges;
	...
	int m_iManaUpkeep;
	int m_iCombatAuraType;
	int m_iReducedCostByYieldOverwrite;
	int m_iPopulationCost;
	int m_iGlobalYieldTypeCost;
	int m_iGlobalYieldCost;
	int m_iExtraLives;
	int m_iBonusNearUF;
	int m_iMinWilderness;
	int m_iMaxWilderness;
	bool m_bNoCitySupportNeeded;
	bool m_bNoEquipment;
	bool m_bNoXP;
	bool m_bScaleWithTech;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
    int m_iCorporationSupportNeeded;
    int* m_paiCorporationSupport;
    int* m_paiCorporationSupportMod;
/*************************************************************************************************/
/**	END	                                        												**/
...
/*************************************************************************************************/
	...
	int getNationalism() const;
	int getReducedEquipmentCost() const;
	bool isPermanent() const;
	bool isBanditLords() const;
	bool isPreservation() const;
	bool isLumberFromAF() const;
	int getCommerceChangesPerCultureLevel(int iCommerce) const;
	int getImpInfrastructureHalfCost() const;
    int getCorporationSupport(int iCorporation) const;
    int getCorporationSupportMultiplier(int iCorporation) const;
/*************************************************************************************************/
/**	END	                                        												**/
...
/*************************************************************************************************/
	...
	bool m_bPermanent;
	bool m_bBanditLords;
	bool m_bPreservation;
	bool m_bLumberFromAF;
	int m_iReducedEquipmentCost;
	int* m_paiCommerceChangesPerCultureLevel;
	int m_iImpInfrastructureHalfCost;
    int* m_paiCorporationSupport;
    int* m_paiCorporationSupportMod;
/*************************************************************************************************/
/**	END	                                        												**/
...
/**	ADDON (New Function Definitions) Sephi                                                      **/
/*************************************************************************************************/
	int m_iReducedCostByYield;
	bool m_bBattleCaptain;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH Buildings: Added by Kael 08/04/2007
	...
	int getPrereqCivVectorSize();
	CvString getPrereqCivVectorElement(int i);
	int getPrereqCivicVectorSize();
	CvString getPrereqCivicVectorElement(int i);
	int getPrereqCiv() const;
...
/*************************************************************************************************/
    ...
    int getMaxManaChange() const;
    int getReducedCostByYieldOverwrite() const;
	int getReducedCostByYield() const;
    int getPopulationLimitChange() const;
	int getPopulationCost() const;
	int getGlobalYieldTypeCost() const;
	int getGlobalYieldCost() const;
	int getUnitSupportChange() const;
	int getLastTurnPossibleBuild() const;
	int getCommercePercentTypeForced() const;
	bool isAdjacentPeak() const;
	bool isAdjacentUF() const;
	bool isDistrict() const;
	bool isReqGlobalYieldIncome() const;
	bool isEnchantment() const;
	int getPrereqBuildingClass() const;
	int getPrereqBuildingClassInAllCities() const;
	int getPrereqImprovement() const;
	int getCommercePerPopulation(int iCommerce) const;
	int getCommercePerCultureLevel(int iCommerce) const;
	int getYieldPerCultureLevel(int iYield) const;

	int getAISpecialization1() const;
	int getAISpecialization2() const;
	int getBonusYieldType() const;
	int getBonusCommerceType() const;

	bool isBonusLinked(int iI) const;
	bool isBonusConsumed(int iI) const;
	bool isBonusNearbyNeeded(int iI) const;
	bool isBuildingClassBlocked(int iI) const;

	int getInitialValue() const;
	int getPerBonusValue() const;
	int getPrereqCivic() const;

	int getImprovementYieldChanges(int i, int j) const;
	int* getImprovementYieldChangesArray(int i);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	int getTrainXPRate(int iI) const;
	int getGlobalTrainXPCap(int iI) const;
	int getGlobalTrainXPRate(int iI) const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	//Added by Darksavant
	bool isDisableGrowth () const;
	bool isDisableProduction () const;
...
/*************************************************************************************************/
    ...
    int m_iMaxManaChange;
    int m_iReducedCostByYieldOverwrite;
	int m_iPopulationCost;
	int m_iGlobalYieldTypeCost;
	int m_iGlobalYieldCost;
	int m_iUnitSupportChange;
	int m_iLastTurnPossibleBuild;
	int m_iCommercePercentTypeForced;
    int m_iPopulationLimitChange;
	bool m_bAdjacentPeak;
	bool m_bAdjacentUF;
	bool m_bDistrict;
	bool m_bReqGlobalYieldIncome;
	bool m_bEnchantment;
	int m_iPrereqBuildingClass;
	int m_iPrereqBuildingClassInAllCities;
	int m_iPrereqImprovement;
	int* m_paiCommercePerPopulation;
	int* m_paiCommercePerCultureLevel;
	int* m_paiYieldPerCultureLevel;

	int m_iAISpecialization1;
	int m_iAISpecialization2;
	int m_iBonusYieldType;
	int m_iBonusCommerceType;

	int m_iInitialValue;
	int m_iPerBonusValue;
	int m_iPrereqCivic;
	// Arrays

	bool* m_pabBonusLinked;
	bool* m_pabBonusConsumed;
	bool* m_pabBonusNearbyNeeded;
	bool* m_pabBuildingClassBlocked;
	int** m_ppiImprovementYieldChanges;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int* m_paiTrainXPCap;
	int* m_paiGlobalTrainXPCap;
	int* m_paiTrainXPRate;
	int* m_paiGlobalTrainXPRate;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
public:
	...
	DllExport bool isCivilizationAllowedCivics(int i) const;				// Exposed to Python
	bool isCivicAllowed(int i) const;
...
//FfH: Added by Kael 08/07/2007
	...
	bool isNativeTerrains(int i) const;
	bool isUnitRoster(int i /* Unit Types */) const; 
	bool isImprovementNonDefault(int i) const;
	bool canBuildImprovement(int Improvement) const;
//FfH: End Add
...
/*************************************************************************************************/
    ...
    bool isNewCiv() const;
    bool isNoFaith() const;
	bool isAlwaysConnectResources() const;
	bool isSpellResearchFromMaintainFeatures() const;
	int getReducedManaCostInGoldenAge() const;
    int getPopulationLimit() const;
    int getImpInfrastructureHalfCost() const;
	int getImprovementCostIncrease() const;
	int getNativePlane() const;
	int getDefaultUnit() const;
    int getFavoredYield() const;
	int getFlavorValue(int i) const;				// Exposed to Python
	const TCHAR* getFlavorCityScreenImage() const;
	const TCHAR* getFlavorScreenImage() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
protected:
	...
	bool* m_pbCivilizationAllowedCivics;
...
//FfH: Added by Kael 08/07/2007
	...
	bool* m_pbNativeTerrains;
	bool* m_pbImprovementNonDefault;
	bool* m_pbUnitRoster;
//FfH: End Add
/*************************************************************************************************/
/**	BETTER AI (New Definitions) Sephi                                           				**/
...
/*************************************************************************************************/
    ...
    bool m_bNewCiv;
    bool m_bNoFaith;
	bool m_bAlwaysConnectResources;
	bool m_bSpellResearchFromMaintainFeatures;
	int m_iReducedManaCostInGoldenAge;
    int m_iPopulationLimit;
    int m_iImpInfrastructureHalfCost;
	int m_iImprovementCostIncrease;
	int m_iNativePlane;
	int m_iDefaultUnit;
    int m_iFavoredYield;
	int* m_piFlavorValue;
	CvString m_szFlavorScreenImage;
	CvString m_szFlavorCityScreenImage;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
public:
	...
	int getDivineJudgementTurnReq() const;
	...
	public CvInfoBase
{
	...
	public:
		...
		int getStonePerProduction() const;					// Exposed to Python
...
public:
	...
	int getAIUnitSupportBonusPercent() const;				// Exposed to Python
...
/**	                                                                 							**/
/*************************************************************************************************/
    int getFreeBonusMana() const;
/** new tags **/
    int getAICombatOddsCapped() const;
    int getAIFreeNobleHouseSupportModifier() const;
    int getAIManaModifier() const;
	int getAIFreeHappinessInterval() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	// Arrays
...
protected:
	...
	int m_iAIUnitSupportBonusPercent;
...
/**	                                                                 							**/
/*************************************************************************************************/
    int m_iFreeBonusMana;
    int m_iAICombatOddsCapped;
    int m_iAIFreeNobleHouseSupportModifier;
    int m_iAIManaModifier;
    int m_iAIFreeHappinessInterval;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
public:
	...
	bool isApplyImprovementCost() const;
	int getTerrainPre() const;
	int getTerrainPost() const;
	// Arrays
...
public:
	...
	bool isFloodPlainsMakesValid() const;				// Exposed to Python
...
//FfH Improvements: Added by Kael 08/07/2007
	...
	int getDestroyAdjacentImprovementChance() const;
	int getRange() const;
...
/*************************************************************************************************/
	int getHealth() const;
	int getImprovementClassType() const;
	int getPrereqTerrainSpreadResources() const;
	int getGoldCost() const;
	int getYieldCost(int iYield) const;
	int getCultureChange() const;	
	int getAdjacentFindResourceModify() const;
	int getMinWilderness() const;
	int getMaxWilderness() const;
	int getSpawnGroup() const;
...
/** multibarb **/
	...
	bool isDefaultBuildableAllCivs() const;
    int getAppearanceTechs(int i) const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH Improvements: Added by Kael 08/07/2007
	...
	int m_iHealRateChange;
	int m_iDestroyAdjacentImprovementChance;
	int m_iRange;
...
/*************************************************************************************************/
	...
	int m_iPrereqTerrainSpreadResources;
	int m_iGoldCost;
	int* m_piYieldCost;
	int m_iCultureChange;
	int m_iAdjacentFindResourceModify;
	int m_iMinWilderness;
	int m_iMaxWilderness;
	int m_iSpawnGroup;
	int m_iDungeonType;
/** multibarb **/
	int m_iNativePlane;
	int m_iSpawnUnitCiv;
	bool m_bDefaultBuildableAllCivs;
    int* m_piAppearanceTechs;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH: End Add
	...
	int getCityYieldModifierType() const;
	int getCityCommerceModifierType() const;
	int getCityBonusModifier() const;
...
//FfH: End Add
	...
	int m_iCityYieldModifierType;
	int m_iCityCommerceModifierType;
	int m_iCityBonusModifier;
	int m_iEnchantedWeaponBonus;
	int m_iMinWilderness;
	int m_iMaxWilderness;
...
/*************************************************************************************************/
	...
	void copyNonDefaultsReadPass2(CvTerrainInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
/*************************************************************************************************/
/**	TrueModular								END													**/
/*************************************************************************************************/
...
//FfH Card Game: Added by Sto 08/08/2008
	DllExport int getSomniumAggressiveness() const;
//FfH: End Add
...
/*************************************************************************************************/
	...
	int getHatedCivicAttitudeChange() const;
	int getHatedCivicAttitudeDivisor() const;
	int getHatedCivicAttitudeChangeLimit() const;
	int getHatedCivic() const;
...
public:
	...
	int getProjectPrereq() const;						// Exposed to Python
	void setAnyoneProjectPrereq(int i);
	void setProjectPrereq(int i);
	int getMaxGlobalInstances() const;						// Exposed to Python
	int getMaxTeamInstances() const;							// Exposed to Python
	int getProductionCost() const;								// Exposed to Python
...
/*************************************************************************************************/
	...
	int getManaUpkeepPerCityTimes100() const;
	int getSummonUnitType() const;
	int getManaSchoolType() const;
	int getNumTerrainChanges() const;
	int getTerrainType1() const;
	int getTerrainType2() const;
	int getTerrainType3() const;
	int getTerrainType4() const;
	int getTerrainType5() const;
	int getTerrainToType1() const;
	int getTerrainToType2() const;
	int getTerrainToType3() const;
	int getTerrainToType4() const;
	int getTerrainToType5() const;
	int getFeatureTypePre() const;
	int getFeatureTypePost() const;
	int getFeatureType2Pre() const;
	int getFeatureType2Post() const;
	bool isCreateFloodPlains() const;
	bool isCreateHellTerrain() const;
	bool isCreateRandom() const;
	bool isCreateHills() const;
	bool isCreatePeak() const;
	bool isRemovePeak() const;
	bool isRemoveHellTerrain() const;
	bool isHostileTerraform() const;
	bool isTargetedTerraform() const;
	bool isWater() const;
	bool isCreateRiver() const;
	bool isCreateLand() const;
	bool isDrownLand() const;
	bool isTransmutationManaBonus() const;
	bool isGlobalEnchantmentManaBonus() const;
	int	getImprovementTypePre() const;
	int	getImprovementType2Pre() const;
	int	getImprovementTypePost() const;
	int	getImprovementType2Post() const;

	bool isBanish() const;
	bool isCallTheVoid() const;
	bool isChaosRift() const;
	bool isBirth() const;
	bool isRessurection() const;
	bool isDivineJudgement() const;
	bool isDeathWish() const;
	bool isEarthQuake() const;
	bool isEffectOnly() const;
	bool isGlobalEnchantment() const;
	bool isHostile() const;
	bool isNatureWrath() const;
	BonusTypes getManaBonusLinked() const;

	int getAwarenessLevel() const;
	int getLastTurnPossibleBuild() const;
	int getClimateRitual() const;
	int getDevilSummon() const;
	int getDiploCharmChange() const;
	int getDiploCharmAlignmentPrereq() const;
	int getDisjunctionPower() const;
	int getDoubleCostOfOtherManaSchools() const;
	int getBuildingType() const;
	int getPromotionType() const;
	int getReduceManaCreation() const;
	int getResistHostileTerraforming() const;
	int getTemporaryTech() const;
	int getCommerceChangeType() const;
	int getCommerceChange() const;
	int getBonusPerMana() const;
	int getYieldChangeType() const;
	int getYieldChange() const;
	int getEffect() const;
	int getPopulationToExperienceRate() const;
	bool isAddPromotionToUnits() const;
...
/*************************************************************************************************/
	...
	int m_iManaCost;
	int m_iManaUpkeep;
	int m_iManaUpkeepPerCityTimes100;
	int m_iSummonUnitType;
	int m_iManaSchoolType;

	int m_iNumTerrainChanges;
	int m_iTerrainType1;
	int m_iTerrainType2;
	int m_iTerrainType3;
	int m_iTerrainType4;
	int m_iTerrainType5;
	int m_iTerrainToType1;
	int m_iTerrainToType2;
	int m_iTerrainToType3;
	int m_iTerrainToType4;
	int m_iTerrainToType5;
	int m_iFeatureTypePre;
	int m_iFeatureTypePost;
	int m_iFeatureType2Pre;
	int m_iFeatureType2Post;
	bool m_bCreateFloodPlains;
	bool m_bCreateHellTerrain;
	bool m_bCreateRandom;
	bool m_bCreateHills;
	bool m_bCreatePeak;
	bool m_bRemovePeak;
	bool m_bRemoveHellTerrain;
	bool m_bHostileTerraform;
	bool m_bTargetedTerraform;

	bool m_bWater;
	bool m_bCreateRiver;
	bool m_bCreateLand;
	bool m_bDrownLand;
	bool m_bTransmutationManaBonus;
	bool m_bGlobalEnchantmentManaBonus;
	int m_iImprovementTypePre;
	int	m_iImprovementType2Pre;
	int	m_iImprovementTypePost;
	int	m_iImprovementType2Post;

	bool m_bBanish;
	bool m_bCallTheVoid;
	bool m_bChaosRift;
	bool m_bBirth;
	bool m_bRessurection;
	bool m_bDivineJudgement;
	bool m_bDeathWish;
	bool m_bEarthQuake;
	bool m_bEffectOnly;
	bool m_bGlobalEnchantment;
	...
	int m_iAwarenessLevel;
	int m_iLastTurnPossibleBuild;
	int m_iClimateRitual;
	int m_iDevilSummon;
	int m_iDiploCharmChange;
	int m_iDiploCharmAlignmentPrereq;
	int m_iDisjunctionPower;
	int m_iDoubleCostOfOtherManaSchools;
	int m_iBuildingType;
	int m_iPromotionType;
	int m_iReduceManaCreation;
	int m_iResistHostileTerraforming;
	int m_iTemporaryTech;
	int m_iCommerceChangeType;
	int m_iCommerceChange;
	int m_iBonusPerMana;
	int m_iYieldChangeType;
	int m_iYieldChange;
	int m_iEffect;
	int m_iPopulationToExperienceRate;
	bool m_bAddPromotionToUnits;
...
public:
	...
	//Added by Darksavant
	int getReligionTerrainYields(int i, int j) const;
...
/**						                                            							**/
/*************************************************************************************************/
    UnitClassTypes getReligionHero1() const;
    UnitClassTypes getReligionHero2() const;
    TechTypes getReligionTech1() const;
    TechTypes getReligionTech2() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH: End Add
	...
	//Added by Darksavant
	int** m_ppiReligionTerrainYields;
...
/**						                                            							**/
/*************************************************************************************************/
    UnitClassTypes m_eReligionHero1;
    UnitClassTypes m_eReligionHero2;
    TechTypes m_eReligionTech1;
    TechTypes m_eReligionTech2;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	// Arrays
...
/*************************************************************************************************/
	...
	bool isIgnoreBuildingGYCost(int iBuilding) const;

	int getIgnoreBuildingGYCostVectorSize();
	CvString getIgnoreBuildingGYCostNamesVectorElement(int i);
	int getIgnoreBuildingGYCostValuesVectorElement(int i);
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH Traits: Added by Kael 08/02/2007
	bool m_bAdaptive;
	bool m_bIgnoreUnHealthFromImprovements;
	bool m_bAgnostic;
...
/**						                                            							**/
/*************************************************************************************************/
	CvString m_szTraitPyPerTurn;
	int m_iManaFromImprovement;
	int m_iManaFromImprovementType;
	int m_iImprovementUpgradeRateModifier;
	bool m_bCultureTrait;
	int m_iPrereqTrait;
...
/*************************************************************************************************/
    int* m_paiCorporationSupport;
    int* m_paiCorporationSupportMod;
    bool* m_paiIgnoreBuildingGYCost;
    ...
    std::vector<CvString> m_aszIgnoreBuildingGYCostforPass3;
	std::vector<int> m_aiIgnoreBuildingGYCostforPass3;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	DllExport bool isAvoidAngryCitizens() const;		// Exposed to Python
	DllExport bool isAvoidUnhealthyCitizens() const;	// Exposed to Python
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	// Arrays
...
public:
	...
	int getBaseTechCost() const;			//	Exposed to Python
	int getBaseSpellresearchCost() const;			//	Exposed to Python
