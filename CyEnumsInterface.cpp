...
/*************************************************************************************************/
		.value("AREA_BORDER_LAYER_SPELL_OFFENSIVE", AREA_BORDER_LAYER_SPELL_OFFENSIVE)
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
	...
	python::enum_<InterfaceModeTypes>("InterfaceModeTypes")
		...
		.value("INTERFACEMODE_TERRAFORM", INTERFACEMODE_TERRAFORM)
/*************************************************************************************************/
/**	ADDON(INTERFACEMODE_SPELL_OFFENSIVE) Sephi					                                **/
/*************************************************************************************************/
		.value("INTERFACEMODE_SPELL_OFFENSIVE", INTERFACEMODE_SPELL_OFFENSIVE)
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_MANA", WIDGET_HELP_MANA)
		.value("WIDGET_HELP_UNITLIMIT", WIDGET_HELP_UNITLIMIT)		
		.value("WIDGET_HELP_FAITH", WIDGET_HELP_FAITH)
		.value("WIDGET_HELP_LUMBER", WIDGET_HELP_LUMBER)
		.value("WIDGET_HELP_LEATHER", WIDGET_HELP_LEATHER)
		.value("WIDGET_HELP_METAL", WIDGET_HELP_METAL)
		.value("WIDGET_HELP_HERB", WIDGET_HELP_HERB)
		.value("WIDGET_HELP_STONE", WIDGET_HELP_STONE)
...
/**	ADDON(Screen) Sephi					                                                        **/
/*************************************************************************************************/
		.value("WIDGET_SPELL_RESEARCH", WIDGET_SPELL_RESEARCH)
		.value("WIDGET_GUILD_SCREEN", WIDGET_GUILD_SCREEN)
		.value("WIDGET_CULTURE_ACHIEVEMENT", WIDGET_CULTURE_ACHIEVEMENT)		
		.value("WIDGET_MAGIC_SCREEN", WIDGET_MAGIC_SCREEN)
		.value("WIDGET_DO_TRAIT_FROM_CULTURE", WIDGET_DO_TRAIT_FROM_CULTURE)
		.value("WIDGET_DO_SUMMON", WIDGET_DO_SUMMON)
		.value("WIDGET_DO_TERRAFORM", WIDGET_DO_TERRAFORM)
		.value("WIDGET_DO_GLOBAL_ENCHANTMENT", WIDGET_DO_GLOBAL_ENCHANTMENT)
		.value("WIDGET_REMOVE_GLOBAL_ENCHANTMENT", WIDGET_REMOVE_GLOBAL_ENCHANTMENT)
		.value("WIDGET_HELP_GOLD", WIDGET_HELP_GOLD)
		.value("WIDGET_HELP_GLOBAL_CULTURE", WIDGET_HELP_GLOBAL_CULTURE)		
		.value("WIDGET_HELP_CITY_SPECIALIZATION", WIDGET_HELP_CITY_SPECIALIZATION)
		.value("WIDGET_HELP_CIVCOUNTER_ELOHIM", WIDGET_HELP_CIVCOUNTER_ELOHIM)		
		.value("WIDGET_HELP_CIVCOUNTER_SCIONS", WIDGET_HELP_CIVCOUNTER_SCIONS)
		.value("WIDGET_TECH_SCREEN", WIDGET_TECH_SCREEN)		
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_PICK_EQUIPMENT", BUTTONPOPUP_PICK_EQUIPMENT)
		.value("BUTTONPOPUP_CHOOSESPELLRESEARCH", BUTTONPOPUP_CHOOSESPELLRESEARCH)		
		.value("BUTTONPOPUP_CHOOSE_GUILD", BUTTONPOPUP_CHOOSE_GUILD)		
		.value("BUTTONPOPUP_CHOOSE_RELIGION", BUTTONPOPUP_CHOOSE_RELIGION)		
		.value("BUTTONPOPUP_DUNGEON_EVENT", BUTTONPOPUP_DUNGEON_EVENT)				
		.value("BUTTONPOPUP_CULTURAL_ACHIEVEMENT", BUTTONPOPUP_CULTURAL_ACHIEVEMENT)				
...
/*************************************************************************************************/
		...
		.value("YIELD_METAL", YIELD_METAL)
		.value("YIELD_HERB", YIELD_HERB)
...
/*************************************************************************************************/
		.value("COMMERCE_MANA", COMMERCE_MANA)
		.value("COMMERCE_FAITH", COMMERCE_FAITH)
		.value("COMMERCE_ARCANE", COMMERCE_ARCANE)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	...
	python::enum_<FlavorTypes>("FlavorTypes")
		.value("FLAVOR_MILITARY", FLAVOR_MILITARY)
		.value("FLAVOR_RELIGION", FLAVOR_RELIGION)
		.value("FLAVOR_PRODUCTION", FLAVOR_PRODUCTION)
		.value("FLAVOR_GOLD", FLAVOR_GOLD)
		.value("FLAVOR_SCIENCE", FLAVOR_SCIENCE)
		.value("FLAVOR_CULTURE", FLAVOR_CULTURE)
		.value("FLAVOR_GROWTH", FLAVOR_GROWTH)
		.value("FLAVOR_ESPIONAGE", FLAVOR_ESPIONAGE)
		.value("FLAVOR_MELEE", FLAVOR_MELEE)
		.value("FLAVOR_ENGINEERING", FLAVOR_ENGINEERING)
		.value("FLAVOR_RECON", FLAVOR_RECON)
		.value("FLAVOR_RANGED", FLAVOR_RANGED)
		.value("FLAVOR_MOUNTED", FLAVOR_MOUNTED)
		.value("FLAVOR_MAGIC", FLAVOR_MAGIC)
		.value("FLAVOR_HAPPY", FLAVOR_HAPPY)
		.value("FLAVOR_NAVAL", FLAVOR_NAVAL)
		.value("FLAVOR_METAL", FLAVOR_METAL)
		.value("FLAVOR_GUILD", FLAVOR_GUILD)
...
//		.value("GAMEOPTION_NO_PLOT_COUNTER", GAMEOPTION_NO_PLOT_COUNTER)
		.value("GAMEOPTION_FLEXIBLE_DIFFICULTY", GAMEOPTION_FLEXIBLE_DIFFICULTY)
		.value("GAMEOPTION_ONE_CITY_CHALLENGE", GAMEOPTION_ONE_CITY_CHALLENGE)
		.value("GAMEOPTION_LEAD_ANY_CIV", GAMEOPTION_LEAD_ANY_CIV)
		.value("GAMEOPTION_THAW", GAMEOPTION_THAW)
		...
		.value("GAMEOPTION_CHALLENGE_HOLY_CITY", GAMEOPTION_CHALLENGE_HOLY_CITY)		
		.value("GAMEOPTION_SHOW_HIDDEN_DIPLO_VALUES",GAMEOPTION_SHOW_HIDDEN_DIPLO_VALUES)

		.value("GAMEOPTION_DOUBLE_EVENTS", GAMEOPTION_DOUBLE_EVENTS)
		...
		.value("GAMEOPTION_SLOWER_XP", GAMEOPTION_SLOWER_XP)
		.value("GAMEOPTION_WILD_MANA", GAMEOPTION_WILD_MANA)
		...
		.value("GAMEOPTION_NO_LAIRS", GAMEOPTION_NO_LAIRS)
		.value("GAMEOPTION_NO_MAP_TRADING",GAMEOPTION_NO_MAP_TRADING)
		.value("GAMEOPTION_NO_PIRATES",GAMEOPTION_NO_PIRATES)
		.value("GAMEOPTION_NO_RELIGION_0", GAMEOPTION_NO_RELIGION_0)
		.value("GAMEOPTION_NO_RELIGION_1", GAMEOPTION_NO_RELIGION_1)
		.value("GAMEOPTION_NO_RELIGION_2", GAMEOPTION_NO_RELIGION_2)
		.value("GAMEOPTION_NO_RELIGION_3", GAMEOPTION_NO_RELIGION_3)
		.value("GAMEOPTION_NO_RELIGION_4", GAMEOPTION_NO_RELIGION_4)
		.value("GAMEOPTION_NO_RELIGION_5", GAMEOPTION_NO_RELIGION_5)
		.value("GAMEOPTION_NO_RELIGION_6", GAMEOPTION_NO_RELIGION_6)
		...
		.value("GAMEOPTION_AI_NO_BUILDING_PREREQS", GAMEOPTION_AI_NO_BUILDING_PREREQS)
		.value("GAMEOPTION_AI_NO_MINIMUM_LEVEL", GAMEOPTION_AI_NO_MINIMUM_LEVEL)
		...
		.value("GAMEOPTION_UNIT_PER_TILE_LIMIT", GAMEOPTION_UNIT_PER_TILE_LIMIT)		
		.value("GAMEOPTION_OPTIMIZATION_MEMORY_LARGE_MAPS", GAMEOPTION_OPTIMIZATION_MEMORY_LARGE_MAPS)				
		.value("GAMEOPTION_PICK_RELIGION", GAMEOPTION_PICK_RELIGION)
		.value("GAMEOPTION_RAGING_BARBARIANS", GAMEOPTION_RAGING_BARBARIANS)
		.value("GAMEOPTION_WINAMP_GUI", GAMEOPTION_WINAMP_GUI)

		.value("GAMEOPTION_RANDOM_PERSONALITIES", GAMEOPTION_RANDOM_PERSONALITIES)

		.value("GAMEOPTION_WB_AGAINST_THE_GREY", GAMEOPTION_WB_AGAINST_THE_GREY)
		.value("GAMEOPTION_WB_AGAINST_THE_WALL", GAMEOPTION_WB_AGAINST_THE_WALL)
		.value("GAMEOPTION_WB_BARBARIAN_ASSAULT", GAMEOPTION_WB_BARBARIAN_ASSAULT)
		.value("GAMEOPTION_WB_BENEATH_THE_HEEL", GAMEOPTION_WB_BENEATH_THE_HEEL)
		.value("GAMEOPTION_WB_BLOOD_OF_ANGELS", GAMEOPTION_WB_BLOOD_OF_ANGELS)
		.value("GAMEOPTION_WB_FALL_OF_CUANTINE", GAMEOPTION_WB_FALL_OF_CUANTINE)
		.value("GAMEOPTION_WB_GIFT_OF_KYLORIN", GAMEOPTION_WB_GIFT_OF_KYLORIN)
		.value("GAMEOPTION_WB_GRAND_MENAGERIE", GAMEOPTION_WB_GRAND_MENAGERIE)
		.value("GAMEOPTION_WB_INTO_THE_DESERT", GAMEOPTION_WB_INTO_THE_DESERT)
		.value("GAMEOPTION_WB_LORD_OF_THE_BALORS", GAMEOPTION_WB_LORD_OF_THE_BALORS)
		.value("GAMEOPTION_WB_MULCARN_REBORN", GAMEOPTION_WB_MULCARN_REBORN)
		.value("GAMEOPTION_WB_RETURN_OF_WINTER", GAMEOPTION_WB_RETURN_OF_WINTER)
		.value("GAMEOPTION_WB_THE_BLACK_TOWER", GAMEOPTION_WB_THE_BLACK_TOWER)
		.value("GAMEOPTION_WB_THE_CULT", GAMEOPTION_WB_THE_CULT)
		.value("GAMEOPTION_WB_THE_MOMUS", GAMEOPTION_WB_THE_MOMUS)
		.value("GAMEOPTION_WB_THE_RADIANT_GUARD", GAMEOPTION_WB_THE_RADIANT_GUARD)
		.value("GAMEOPTION_WB_THE_SPLINTERED_COURT", GAMEOPTION_WB_THE_SPLINTERED_COURT)
		.value("GAMEOPTION_WB_WAGES_OF_SIN", GAMEOPTION_WB_WAGES_OF_SIN)
		.value("GAMEOPTION_WB_EXTRA", GAMEOPTION_WB_EXTRA)
		.value("GAMEOPTION_WB_LOAD_SCREEN", GAMEOPTION_WB_LOAD_SCREEN)
		.value("GAMEOPTION_ADVENTURE_MODE", GAMEOPTION_ADVENTURE_MODE)
		.value("GAMEOPTION_NO_PROJECTS", GAMEOPTION_NO_PROJECTS)
		.value("GAMEOPTION_NO_HEALING_FOR_HUMANS", GAMEOPTION_NO_HEALING_FOR_HUMANS)
		.value("GAMEOPTION_NO_INFLATION", GAMEOPTION_NO_INFLATION)
		.value("GAMEOPTION_NO_MAINTENANCE", GAMEOPTION_NO_MAINTENANCE)
		.value("GAMEOPTION_NO_WAR_WEARINESS", GAMEOPTION_NO_WAR_WEARINESS)
		.value("GAMEOPTION_ALWAYS_OPEN_BORDERS", GAMEOPTION_ALWAYS_OPEN_BORDERS)
		.value("GAMEOPTION_ALWAYS_RAZE", GAMEOPTION_ALWAYS_RAZE)
...
/**						                                            							**/
/*************************************************************************************************/
		.value("CHAR_BARB", CHAR_BARB)
		.value("CHAR_ANIMAL", CHAR_ANIMAL)
		.value("CHAR_DEMON", CHAR_DEMON)
		.value("CHAR_ATT_1", CHAR_ATT_1)
		.value("CHAR_ATT_2", CHAR_ATT_2)
		.value("CHAR_ATT_3", CHAR_ATT_3)
		.value("CHAR_ATT_4", CHAR_ATT_4)
		.value("CHAR_ATT_5", CHAR_ATT_5)
		.value("CHAR_INFRASTRUCTURE", CHAR_INFRASTRUCTURE)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**	ADDON(Screen) Sephi					                                                        **/
/*************************************************************************************************/
		.value("TASK_NEW_TRAIT", TASK_NEW_TRAIT)
		.value("TASK_SUMMON", TASK_SUMMON)
		.value("TASK_TERRAFORM", TASK_TERRAFORM)
		.value("TASK_GLOBAL_ENCHANTMENT", TASK_GLOBAL_ENCHANTMENT)
		.value("TASK_REMOVE_GLOBAL_ENCHANTMENT", TASK_REMOVE_GLOBAL_ENCHANTMENT)
		.value("TASK_CITY_INFRASTRUCTURE_INCREASE", TASK_CITY_INFRASTRUCTURE_INCREASE)
		.value("TASK_CULTURAL_ACHIEVEMENT", TASK_CULTURAL_ACHIEVEMENT)		
		.value("TASK_CITY_DUNGEON_EVENT", TASK_CITY_DUNGEON_EVENT)		
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
		;
...
/*************************************************************************************************/
	python::enum_<WildmanaConceptTypes>("WildmanaConceptTypes")
		.value("NO_WILDMANACONCEPT", NO_WILDMANACONCEPT)
		;

	python::enum_<WildmanaGuideTypes>("WildmanaGuideTypes")
		.value("NO_WILDMANAGUIDE", NO_WILDMANAGUIDE)
		;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
		.value("UNITAI_MANADEFENDER", UNITAI_MANADEFENDER)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
		...
		.value("UNITAI_MAGE", UNITAI_MAGE)
		.value("UNITAI_TERRAFORMER", UNITAI_TERRAFORMER)
		.value("UNITAI_MANA_UPGRADE", UNITAI_MANA_UPGRADE)
		.value("UNITAI_WARWIZARD", UNITAI_WARWIZARD)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
        .value("AUTOMATE_FREE_IMPROVEMENT", AUTOMATE_FREE_IMPROVEMENT)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**	ADDON(INTERFACEMODE_SPELL_OFFENSIVE) Sephi					                                **/
/*************************************************************************************************/
		.value("MISSION_SPELL_OFFENSIVE", MISSION_SPELL_OFFENSIVE )
		.value("MISSION_TERRAFORM", MISSION_TERRAFORM )
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
		.value("COMMAND_AUTOMATE_SPELL", COMMAND_AUTOMATE_SPELL)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
		.value("COMMAND_RANGESTRIKE", COMMAND_RANGESTRIKE)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH: End Add
		.value("COMMAND_PICK_EQUIPMENT", COMMAND_PICK_EQUIPMENT)
		.value("COMMAND_GARRISION", COMMAND_GARRISION)
		.value("COMMAND_PROJECT", COMMAND_PROJECT)
...
//FfH: Added by Kael 09/24/2008
		.value("CONTROL_TROPHY", CONTROL_TROPHY)
//FfH: End Add
/*************************************************************************************************/
/**	ADDON(Houses of Erebus/Screen) Sephi                                                        **/
/*************************************************************************************************/
        .value("CONTROL_GUILD_SCREEN", CONTROL_GUILD_SCREEN)
        .value("CONTROL_MAGIC_SCREEN", CONTROL_MAGIC_SCREEN)
        .value("CONTROL_ARCANE_SCREEN", CONTROL_ARCANE_SCREEN)
/*************************************************************************************************/
/**	END                                                                                         **/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.value("CONTROL_WINAMP_PLAY", CONTROL_WINAMP_PLAY)
		.value("CONTROL_WINAMP_STOP", CONTROL_WINAMP_STOP)
		.value("CONTROL_WINAMP_PAUSE", CONTROL_WINAMP_PAUSE)
		.value("CONTROL_WINAMP_NEXT", CONTROL_WINAMP_NEXT)
		.value("CONTROL_WINAMP_PREV", CONTROL_WINAMP_PREV)
/*************************************************************************************************/
/**	ADDON (WINAMP)						END														**/
/*************************************************************************************************/
...
//FfH Spell System: Added by Kael 07/23/2007
	python::enum_<SpellTypes>("SpellTypes")
		.value("NO_SPELL", NO_SPELL)
		;
//FfH: End Add
...
//		.value("FEAT_PAD", FEAT_PAD)
		.value("FEAT_CORPORATION_ENABLED", FEAT_CORPORATION_ENABLED)
		.value("FEAT_PAD", FEAT_PAD)
		.value("FEAT_TRUST", FEAT_TRUST)
		.value("FEAT_HEAL_UNIT_PER_TURN", FEAT_HEAL_UNIT_PER_TURN)
		.value("FEAT_GLOBAL_SPELL", FEAT_GLOBAL_SPELL)
//FfH: End Modify
/*************************************************************************************************/
/**	BETTER AI (New Functions Definition) Sephi                                 					**/
/**																								**/
/**						                                            							**/
/*************************************************************************************************/
 		.value("FEAT_REPUBLIC_GAINED_AGGRESSIVE", FEAT_REPUBLIC_GAINED_AGGRESSIVE)
		.value("FEAT_REPUBLIC_GAINED_DEFENDER", FEAT_REPUBLIC_GAINED_DEFENDER)
		.value("FEAT_REPUBLIC_GAINED_EXPANSIVE", FEAT_REPUBLIC_GAINED_EXPANSIVE)
		.value("FEAT_REPUBLIC_GAINED_FINANCIAL", FEAT_REPUBLIC_GAINED_FINANCIAL)
		.value("FEAT_REPUBLIC_GAINED_PHILOSOPHICAL", FEAT_REPUBLIC_GAINED_PHILOSOPHICAL)
		.value("FEAT_REPUBLIC_GAINED_INDUSTRIOUS", FEAT_REPUBLIC_GAINED_INDUSTRIOUS)
		.value("FEAT_REPUBLIC_GAINED_SPIRITUAL", FEAT_REPUBLIC_GAINED_SPIRITUAL)
		.value("FEAT_REPUBLIC_GAINED_ORGANIZED", FEAT_REPUBLIC_GAINED_ORGANIZED)
		.value("FEAT_EXPEDITION_READY", FEAT_EXPEDITION_READY)
		...
		.value("FEAT_ARTIFACT_1", FEAT_ARTIFACT_1)
		.value("FEAT_ARTIFACT_2", FEAT_ARTIFACT_2)
		.value("FEAT_ARTIFACT_3", FEAT_ARTIFACT_3)
		.value("FEAT_ARTIFACT_4", FEAT_ARTIFACT_4)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH Spell System: Added by Kael 07/23/2007
		.value("CIVILOPEDIA_PAGE_EFFECT", CIVILOPEDIA_PAGE_EFFECT)
		.value("CIVILOPEDIA_PAGE_HERO", CIVILOPEDIA_PAGE_HERO)
//>>>>BUGFfH: Modified by Denev 2009/09/19
//		.value("CIVILOPEDIA_PAGE_ITEM", CIVILOPEDIA_PAGE_ITEM)
		.value("CIVILOPEDIA_PAGE_EQUIPMENT", CIVILOPEDIA_PAGE_EQUIPMENT)
//<<<<BUGFfH: End Modify
		.value("CIVILOPEDIA_PAGE_RACE", CIVILOPEDIA_PAGE_RACE)
		.value("CIVILOPEDIA_PAGE_SPELL", CIVILOPEDIA_PAGE_SPELL)
		.value("CIVILOPEDIA_PAGE_UNIQUE_FEATURE", CIVILOPEDIA_PAGE_UNIQUE_FEATURE)
//FfH: End Add
...
/**	ADDON (New Pedia Categories) Sephi                                      					**/
/*************************************************************************************************/
		.value("CIVILOPEDIA_PAGE_CONCEPT_WILDMANA", CIVILOPEDIA_PAGE_CONCEPT_WILDMANA)
		.value("CIVILOPEDIA_PAGE_WILDMANA_GUIDE", CIVILOPEDIA_PAGE_WILDMANA_GUIDE)
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/

//>>>>BUGFfH: Added by Denev 2009/09/19
		.value("CIVILOPEDIA_PAGE_ABILITY", CIVILOPEDIA_PAGE_ABILITY)
		.value("CIVILOPEDIA_PAGE_TRAIT", CIVILOPEDIA_PAGE_TRAIT)
		.value("CIVILOPEDIA_PAGE_HISTORY", CIVILOPEDIA_PAGE_HISTORY)
//<<<<BUGFfH: End Add
...
/*************************************************************************************************/
	...
	python::enum_<AIEconomyTypes>("AIEconomyTypes")
		.value("NO_AIECONOMY", NO_AIECONOMY)
		.value("AIECONOMY_CENTRALIZATION", AIECONOMY_CENTRALIZATION)
		.value("AIECONOMY_COTTAGE", AIECONOMY_COTTAGE)
		.value("AIECONOMY_TRADE", AIECONOMY_TRADE)
		.value("AIECONOMY_FOL", AIECONOMY_FOL)
		;
}
