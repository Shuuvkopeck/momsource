...
int CyCity::hurryStone(int /*HurryTypes*/ iHurry)
{
	return m_pCity ? m_pCity->hurryStone((HurryTypes)iHurry) : -1;
}
...
/*************************************************************************************************/
void CyCity::swapAustrinCities(CyPlot* pNewPlot)
{
if (m_pCity)
		m_pCity->swapAustrinCities(pNewPlot->getPlot());
}

int CyCity::getPopulationLimit() const
{
...
/**						                                            							**/
/*************************************************************************************************/
int CyCity::AI_neededPermDefense()
{
    return m_pCity ? m_pCity->AI_neededPermDefense() : -1;
}
...
int CyCity::getGreatPeopleUnitRateTotal(int /*UnitTypes*/ iIndex)
{
	return m_pCity ? m_pCity->getGreatPeopleUnitRateTotal((UnitTypes)iIndex) : -1;
}

int CyCity::getGreatPeopleThreshold()
{
	return m_pCity ? m_pCity->getGreatPeopleThreshold() : -1;
}

int CyCity::getNextGreatPersonInfo(bool bType) const
{
	return m_pCity ? m_pCity->getNextGreatPersonInfo(bType) : -1;
}

int CyCity::getCommercePercentTypeForced() const
{
	return m_pCity ? m_pCity->getCommercePercentTypeForced() : -1;
}

void CyCity::changeBuildingCommerceChange(int eBuildingClass, int eCommerce, int iChange)
{
	return m_pCity ? m_pCity->changeBuildingCommerceChange((BuildingClassTypes)eBuildingClass, (CommerceTypes)eCommerce, iChange) : -1;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
const TCHAR* CyCity::getUnitArtStyleButton(int iUnit) const
{
	return m_pCity ? m_pCity->getUnitArtStyleButton((UnitTypes)iUnit) : TEXT("");
}
//<<<<BUGFfH: End Add
...
int CyCity::calculateImprovementInfrastructureCost()
{
	return m_pCity ? m_pCity->calculateImprovementInfrastructureCost() : -1;
}
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
int CyCity::getBuildingBonusChange(int /*BuildingClassTypes*/ eBuildingClass, int /*BonusTypes*/ eBonus) const
{
	return m_pCity ? m_pCity->getBuildingBonusChange((BuildingClassTypes)eBuildingClass, (BonusTypes)eBonus) : 0;
}

void CyCity::setBuildingBonusChange(int /*BuildingClassTypes*/ eBuildingClass, int /*BonusTypes*/ eBonus, int iChange)
{
	if (m_pCity)
	{
		m_pCity->setBuildingBonusChange((BuildingClassTypes)eBuildingClass, (BonusTypes)eBonus, iChange);
	}
}
/*************************************************************************************************/
