...
/*************************************************************************************************/
		.def("getANIMAL_PLAYER", &CyGlobalContext::getANIMAL_PLAYER, "int ()")
		.def("getANIMAL_TEAM", &CyGlobalContext::getANIMAL_TEAM, "int ()")
		.def("getWILDMANA_PLAYER", &CyGlobalContext::getWILDMANA_PLAYER, "int ()")
		.def("getWILDMANA_TEAM", &CyGlobalContext::getWILDMANA_TEAM, "int ()")
		.def("getPIRATES_PLAYER", &CyGlobalContext::getPIRATES_PLAYER, "int ()")
		.def("getPIRATES_TEAM", &CyGlobalContext::getPIRATES_TEAM, "int ()")
		.def("getWHITEHAND_PLAYER", &CyGlobalContext::getWHITEHAND_PLAYER, "int ()")
		.def("getWHITEHAND_TEAM", &CyGlobalContext::getWHITEHAND_TEAM, "int ()")
		.def("getDEVIL_PLAYER", &CyGlobalContext::getDEVIL_PLAYER, "int ()")
		.def("getDEVIL_TEAM", &CyGlobalContext::getDEVIL_TEAM, "int ()")
		.def("getORC_PLAYER", &CyGlobalContext::getORC_PLAYER, "int ()")
		.def("getORC_TEAM", &CyGlobalContext::getORC_TEAM, "int ()")
		.def("getMERCENARIES_PLAYER", &CyGlobalContext::getMERCENARIES_PLAYER, "int ()")
		.def("getMERCENARIES_TEAM", &CyGlobalContext::getMERCENARIES_TEAM, "int ()")
/**	ADDON (Adventure) Sephi                                                    					**/
		.def("getMAX_ADVENTURESTEPS", &CyGlobalContext::getMAX_ADVENTURESTEPS, "int ()")
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
