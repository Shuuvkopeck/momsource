...
/*************************************************************************************************/
	...
	int hurryStone(HurryTypes eHurry) const;												// Exposed to Python
	...
	int getGreatPeopleThreshold() const;
	void changeGreatPeopleThreshold(int iChange);
	...
	int calculateCorporationMaintenanceTimes100(CorporationTypes eCorporation) const;// Exposed to Python									// Exposed to Python
	...
	int calculateSpellResearchFromFeaturesTimes100() const;
	int calculateBaseTaxes() const;
	int calculateTaxesTimes100() const;
	int calculateTaxes() const;
	int calculateTaxesModifier() const;
	...
	int getImprovementHealthChange() const;
	...
	void changeBaseYieldRate(YieldTypes eIndex, int iChange, bool bGlobalYields = false);												// Exposed to Python
	...
	int getCityBonusYieldRateModifier(YieldTypes eIndex) const;											// Exposed to Python
	void calculateCityBonusYieldRateModifier();
	...
	int getCityBonusCommerceRateModifier(CommerceTypes eIndex) const;																				// Exposed to Python
	void calculateCityBonusCommerceRateModifier();																				// Exposed to Python
	...
	int getGreatPeopleUnitRateTotal(UnitTypes eIndex) const;
...
//FfH: End Add
	...
	virtual int AI_specialistValueNew(SpecialistTypes eSpecialist) = 0;
...
/**						                                            							**/
/*************************************************************************************************/
    virtual int AI_neededPermDefense() = 0;
    virtual int AI_CityDangerValue() = 0;
	virtual CvAIGroup* getAIGroup_Defense() = 0;
	virtual CvAIGroup* getAIGroup_Defense_Replace() = 0;
	virtual CvAIGroup* getAIGroup_Worker() = 0;
	virtual void AI_bestPlotBuild(CvPlot* pPlot) = 0;
//	virtual void AI_bestPlotBuild_parallel(void *arg);
	virtual CvPlot* getAI_WorstPlot() const = 0;
	//debug
	virtual	int AI_getBuildingValue(BuildingTypes eBuilding) = 0;
	virtual int AI_getUnitValue(UnitTypes eUnit) = 0;
/*************************************************************************************************/
/**	END                                                                  						**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
    void swapAustrinCities(CvPlot* pNewPlot);
    int getMistDensity() const;
    void changeMistDensity(int iChange);
    bool isHasDistrict() const;
    void setHasDistrict(bool bNewValue);

    int getGPPThresholdReductionPercent() const;
    void changeGPPThresholdReductionPercent(int iChange);
	int calculateGPPThresholdReductionByCulture() const;
	int calculateGPPThresholdReductionByPopulation() const;

	int getBuildingClassBlocked(int iType) const;
	void changeBuildingClassBlocked(int iType, int iChange);
	bool isBuildingClassBlocked(int iType) const;
	int getCitySpecialization(int iType) const;
	void changeCitySpecialization(int iType, int iChange);
	int getCitySpecializationLevel(int iType) const;
	void changeCitySpecializationLevel(int iType, int iChange);
	int getTotalSpecializationLevel() const;
	void changeTotalSpecializationLevel(int iChange);
	int getCitySpecializationIncome(int iSpecializationType) const;
	int getInfrastructureLevel() const;
	void changeInfrastructureLevel(int iChange);
	int getCommercePercentTypeForced() const;
	void setCommercePercentTypeForced(CommerceTypes iNewvalue);
	int getCityCommercePercent(CommerceTypes eCommerceType) const;
	int getCultureFromImprovements() const;
	void setCultureFromImprovements(int iChange);
	void updateCultureFromImprovements();
	int getUnitSupport() const;
	void changeUnitSupport(int iChange);
    int getPopulationLimit() const;
    void changePopulationLimit(int iChange);
	int getCitySpecializationThreshold(int iType) const;
	void doCitySpecialization();
	bool canHaveReligion(ReligionTypes eReligion);
	int getImprovementInfrastructureCost() const;
	void updateImprovementInfrastructureCost();
	void updateBonusConsumed(BuildingTypes eBuilding, int iChange);
	int calculateImprovementInfrastructureCost(int iCount, int iFreeImps);
	int calculateImprovementInfrastructureCost(ImprovementTypes eImprovement);
	int calculateImprovementInfrastructureCost(int iNextImprovementType = NO_IMPROVEMENT);
	int calculateImprovementInfrastructureCostFreeBase();
	int calculateImprovementInfrastructureCostFreeCulture();
	int calculateImprovementInfrastructureCostFreePopulation();
	int calculateImprovementInfrastructureCostFreeModifier();
	int calculateImprovementInfrastructureCostFree();
	int calculateImprovementInfrastructureCostFreeLeft();
	int getNumFavoredImprovements() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**	                                                                 							**/
/*************************************************************************************************/
    int calculateTradeProfitTimes100(CvCity* pCity) const;
    int calculateTradeYieldTimes100(YieldTypes eIndex, int iTradeProfit) const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	const TCHAR* getUnitArtStyleButton(UnitTypes eUnit) const;
...
/**                                                                                              */
/*************************************************************************************************/
	bool isProductionWonderOrWorldUnit() const;
...
/*************************************************************************************************/
	...
	int getYieldIncome(int iI) const;
	void updateYieldIncome(int iYield);
	int calculateCityYieldIncome(int iYield) const;
	int getExtraYieldIncome(int iYield, int iExtra = 0);
	CvUnit* PlaceUnit(UnitTypes eUnit, PlayerTypes ePlayer, UnitAITypes eUnitAI);
	int getCommercePerPopulation(int iCommerce) const;
	void changeCommercePerPopulation(int iChange, int iCommerce);
	int getCommercePerCultureLevel(int iCommerce) const;
	void changeCommercePerCultureLevel(int iChange, int iCommerce);
	int getYieldPerCultureLevel(int iYield);
	void changeYieldPerCultureLevel(int iChange, int iYield);
	void processCultureLevel(int iOldLevel, int iNewLevel);
	int getYieldFromBonus(int iYield) const;
	void changeYieldFromBonus(int iYield, int iChange);
	int getCommerceFromBonus(int iCommerce) const;
	void changeCommerceFromBonus(int iCommerce, int iChange);
	void updateCommerceFromBonus(int iCommerceType);
	void updateCommerceFromBonus();
	void updateYieldFromBonus(int iYieldType);
	void updateYieldFromBonus();
	int getCommerceFromUnits(int iCommerce) const;
	void updateCommerceFromUnits();
	int getCultureRadius(int iCultureLevel) const;
	int calculateCitySpecializationPointsPerTurn(ProcessTypes eProcess) const;
	int getNextGreatPersonInfo(bool bType) const;
	int getRevoltValue() const;
	bool isNearPeak() const;
	void removeBuildings(BuildingTypes eBuilding, int* iCount);
	void removeBuildingsWhenConquered(bool bConquest);
	int getGlobalYieldCost(BuildingTypes eBuilding) const;
	int getGlobalYieldCost(UnitTypes eUnit) const;
	void spawnGarrisonUnits() const;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
	int getBuildingBonusChange(BuildingClassTypes eBuildingClass, BonusTypes eBonus) const;           // Exposed to Python
	void setBuildingBonusChange(BuildingClassTypes eBuildingClass, BonusTypes eBonus, int iChange);          // Exposed to Python
	void changeBuildingBonusChange(BuildingClassTypes eBuildingClass, BonusTypes eBonus, int iChange);
	void calculateBuildingBonus(BuildingClassTypes eBuildingClass, BonusTypes eBonus, int iNumBuilding);
/*************************************************************************************************/
...
/*************************************************************************************************/
/**
	int getViewportX() const;									// Exposed to Python
	int getViewportY() const;									// Exposed to Python
...
protected:
	...
	int m_iImprovementHealthChange;
...
/*************************************************************************************************/
	...
	int m_iImprovementInfrastructureCost;
	int* m_paiYieldFromBonus;
	int* m_paiCommerceFromBonus;
	int* m_paiCommerceFromUnits;
	int* m_paiBuildingClassBlocked;
	int* m_paiCitySpecialization;
	int* m_paiCitySpecializationLevel;
	int m_iTotalSpecializationLevel;
	int m_iInfrastructureLevel;
	int m_iCommercePercentTypeForced;
	int m_iUnitSupport;
	int m_iCultureFromImprovements;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**						                                            							**/
/*************************************************************************************************/
	std::vector<BuildingBonusChange> m_aBuildingBonusChange;
/*************************************************************************************************/
/**	END Change Building Bonuses	                                        						**/
/*************************************************************************************************/
	...
	int* m_aiCityBonusYieldRateModifier;
	int* m_aiTradeYield;
	...
	int* m_aiCityBonusCommerceRateModifier;
	...
	int getHurryStone(HurryTypes eHurry, int iHurryCost) const;
