...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		.def("changeBaseCombatStr", &CyUnit::changeBaseCombatStr, "void (int)")
		.def("changeBaseCombatStrDefense", &CyUnit::changeBaseCombatStrDefense, "void (int)")
		.def("changeBaseCombatFromPotion", &CyUnit::changeBaseCombatFromPotion, "void (int)")
		.def("changeBaseCombatDefenseFromPotion", &CyUnit::changeBaseCombatDefenseFromPotion, "void (int)")
		.def("getRawBaseCombatStr", &CyUnit::getRawBaseCombatStr, "int ()")
		.def("getRawBaseCombatStrDefense", &CyUnit::getRawBaseCombatStrDefense, "int ()")
...
//FfH Spell System: Added by Kael 07/23/2007
		...
		.def("doEscape", &CyUnit::doEscape, "void ()")
		...
		.def("isIgnoreHide", &CyUnit::isIgnoreHide, "bool ()")
		.def("setIgnoreHide", &CyUnit::setIgnoreHide, "void (bool bNewValue)")
...
/*************************************************************************************************/
        ...
        .def("getOriginPlot", &CyUnit::getOriginPlot,python::return_value_policy<python::manage_new_object>(),  "CyUnit* ()")
        .def("setOriginPlot", &CyUnit::setOriginPlot, "void (CyUnit* pNewUnit)")
        ...
        .def ("exploreLair", &CyUnit::exploreLair, "void ()")
        .def ("equip", &CyUnit::equip, "void (int bool)")
        .def ("changeAIControl", &CyUnit::changeAIControl, "void (int)")		
		.def ("getEquipment", &CyUnit::getEquipment, "int (int)")
		.def ("isImmuneToCapture", &CyUnit::isImmuneToCapture, "bool ()")
		.def ("changeDurability", &CyUnit::changeDurability, "void (int iCategory, int iChange)")		
		.def ("isHeadSelectedUnit", &CyUnit::isHeadSelectedUnit, "bool ()")
		.def ("changeCannotLeaveCulture", &CyUnit::changeCannotLeaveCulture, "void (int iChange)")				
		.def ("changeStrengthPotionsUsed", &CyUnit::changeStrengthPotionsUsed, "void (int iChange)")				
		.def ("displayMessagePromotionGainedInBattle", &CyUnit::displayMessagePromotionGainedInBattle, "void (int iPromotion)")						
/** Better Promotions **/
		.def("AI_getPromotionSpecialization", &CyUnit::AI_getPromotionSpecialization, "int ()")
		.def("AI_setPromotionSpecialization", &CyUnit::AI_setPromotionSpecialization, "void (int newSpecial)")
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
//FfH: End Add
