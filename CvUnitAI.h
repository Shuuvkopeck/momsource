...
/*************************************************************************************************/
    void AI_MercenariesHeadHunterMove();
    void AI_MercenariesPillagerMove();
    void AI_MercenariesRaiderMove();
    void AI_MercenariesMoveToSupport();
...
/*************************************************************************************************/
/** Better Promotions **/
    int AI_getPromotionSpecialization() const;
    void AI_setPromotionSpecialization(int newSpecial);

	//AI_update Subfunctions
	bool AI_update_main();
	void AI_update_debug();
	bool AI_update_specialCases();
	bool AI_update_AIControl();
	bool AI_update_Automated();

    bool AI_groupheal(int iDamagePercent = 0, int iMaxPath = MAX_INT);

	// AIGroup Functions
	void AIGroup_Reserve_join(int iArea);
	void AIGroup_Reserve_naval_join(int iArea);

    // Groupflag Move Functions
	...
	void AI_EsusMissionaryMove();
	void AI_PillageGroupMove();
    void AI_AwakenedMove();
    void AI_CreeperMove();
	void CheckForEquipment();
    void SettlergroupMove();
    bool AI_CaptureManaNodes();
...
// heroes
	...
	void AI_workerSearchForFreeImprovementMove();
    ...
    int AI_getSettlerPatrolUnitsNeeded();
    bool AI_exploreLair();
    ...
    void AI_setWasAttacked(int iNewValue);
    int AI_getWasAttacked();

    bool AI_barbSpecialActionMove(); //called in AI_barbattackmove
	void castAnyTarget(int iThreshold, bool bOtherArea);
/** BETTER AI (Naval AI) Sephi                                                                   **/
    void AI_SettleNavalMove();
    void AI_SettleNavalNewMove();
    void AI_SettleNavalPickupMove();
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
    ...
    int m_iWasAttacked;    //Was attacked by Ranged Attacks, maybe also include Spells?
/** Better Promotions **/
    int  m_iPromotionSpecialization;
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
	...
	void AI_settleMove();
	void AI_workerMove();
	bool AI_createImprovement(bool bSwitch);
...
//FfH: End Add
	...
	bool AI_connectCity();
	bool AI_routeCity(bool bUnconnectedOnly = false);
